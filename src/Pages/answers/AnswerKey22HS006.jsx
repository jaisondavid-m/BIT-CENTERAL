...
const answerKey = [
  // ─── UNIT I ───
  {
    ...
    answerEnglish: "Paruthi Pendir refers to the women cotton workers who were involved in the cotton-related trades during the Sangam period. They were the women who worked with cotton (paruthi) — spinning, weaving, and selling cotton garments. They represent the organized participation of women in the ancient Tamil textile industry.",
    answerTamil: "பருத்திப்பெண்டீர் என்பவர் சங்க காலத்தில் பருத்தி தொழிலில் ஈடுபட்ட பெண்கள் ஆவர். இவர்கள் பருத்தி நூல் நூற்பது, நெசவு செய்வது மற்றும் ஆடைகள் விற்பனை செய்வது போன்ற பணிகளில் ஈடுபட்டனர். பண்டைய தமிழ் நெசவு தொழிலில் பெண்களின் பங்களிப்பை இவர்கள் பிரதிநிதித்துவப்படுத்துகின்றனர்.",
    keywordsEnglish: ["cotton workers", "women", "Sangam period", "textile", "spinning"],
    keywordsTamil: ["பருத்தி தொழிலாளர்", "பெண்கள்", "சங்க காலம்", "நெசவு", "நூற்பு"],
  },
  {
    unit: "Unit I", qNo: 2, marks: 2,
    questionEnglish: "What is 'Paa' or 'Paavottuthal'?",
    questionTamil: "பா அல்லது பாவோட்டுதல் என்றால் என்ன?",
    answerEnglish: "'Paa' or 'Paavottuthal' refers to the process of passing the weft thread through the warp threads during weaving. It is the fundamental action of the weaving process where the shuttle carrying the weft yarn is thrown across the loom between the raised and lowered warp threads to interlace them.",
    answerTamil: "பா அல்லது பாவோட்டுதல் என்பது நெசவு செய்யும் போது ஊடுநூலை (weft) படுகை நூல்களுக்கு (warp) இடையே கடத்தும் செயல்முறை ஆகும். இது நெசவின் அடிப்படை செயலாகும். தறியில் மேலும் கீழும் நிலைப்படுத்தப்பட்ட நூல்கள் இடையே ஊடுநூல் கொண்ட மாக்கு (shuttle) கடத்தப்படும்.",
    keywordsEnglish: ["weft", "warp", "weaving process", "shuttle", "loom"],
    keywordsTamil: ["ஊடுநூல்", "படுகை நூல்", "நெசவு செயல்", "மாக்கு", "தறி"],
  },
  {
    unit: "Unit I", qNo: 3, marks: 2,
    questionEnglish: "What are the types of weaving?",
    questionTamil: "நெசவின் வகைகள் யாவை?",
    answerEnglish: "The main types of weaving are: (1) Plain weave – simple interlacing of warp and weft; (2) Twill weave – diagonal pattern; (3) Satin weave – smooth glossy surface; (4) Jacquard weave – complex patterned fabric. Ancient Tamil weavers practiced plain and patterned weaving for producing silk, cotton, and muslin fabrics.",
    answerTamil: "நெசவின் முக்கிய வகைகள்: (1) தட்டை நெசவு – எளிய படுகை-ஊடு கலவை; (2) சரிவு நெசவு (Twill) – மூலை வடிவம்; (3) சாட்டின் நெசவு – மிருதுவான பளபளப்பு மேற்பரப்பு; (4) ஜாக்கார்ட் நெசவு – சிக்கலான வடிவ நெசவு. சங்க கால தமிழ் நெசவாளர்கள் பட்டு, பருத்தி மற்றும் மெல்லிய வகை ஆடைகளை தயாரித்தனர்.",
    keywordsEnglish: ["plain weave", "twill weave", "satin weave", "Jacquard", "warp", "weft"],
    keywordsTamil: ["தட்டை நெசவு", "சரிவு நெசவு", "சாட்டின் நெசவு", "படுகை நூல்", "ஊடுநூல்"],
  },
  {
    ...
    answerEnglish: "Two important parts of a loom are: (1) Shuttle (மாக்கு) – a boat-shaped device that carries the weft thread across the warp threads during weaving; (2) Reed (ஆழி / பல்) – a comb-like frame that separates warp threads and packs the weft tightly after each pass.",
    answerTamil: "தறியின் இரு முக்கிய பகுதிகள்: (1) மாக்கு (Shuttle) – ஊடுநூலை படுகை நூல்களுக்கு இடையே கொண்டு செல்லும் படகு வடிவ கருவி; (2) ஆழி/பல் (Reed) – வாரிக் கொண்ட சட்டம், படுகை நூல்களை பிரித்து ஊடுநூலை இறுக்கமாக அடிக்கப் பயன்படுகிறது.",
    keywordsEnglish: ["shuttle", "reed", "warp", "weft", "loom"],
    keywordsTamil: ["மாக்கு", "ஆழி", "படுகை நூல்", "ஊடுநூல்", "தறி"],
  },
  {
    ...
    answerEnglish: "During the Sangam period, woven garments were sold at markets called 'Angadi' (அங்காடி). Merchants transported fabrics through trade routes using carts and ships. Cloth was also traded in exchange (barter) for other goods. Fine muslin (கூலம்) was exported to Rome and Arabia, bringing wealth to ancient Tamil ports like Puhar and Musiri.",
    answerTamil: "சங்க காலத்தில் நெசவு ஆடைகள் 'அங்காடி' என்ற சந்தைகளில் விற்கப்பட்டன. வணிகர்கள் வண்டி மற்றும் கப்பல்கள் மூலம் துணிகளை கொண்டு சென்றனர். மற்ற பொருட்களுடன் பண்டமாற்று முறையிலும் விற்றனர். மெல்லிய நூலாடை (கூலம்) ரோம் மற்றும் அரேபியாவுக்கு ஏற்றுமதி செய்யப்பட்டது.",
    keywordsEnglish: ["Angadi", "market", "barter", "export", "Puhar", "Musiri"],
    keywordsTamil: ["அங்காடி", "சந்தை", "பண்டமாற்று", "ஏற்றுமதி", "புகார்", "முசிறி"],
  },
  {
    ...
    answerEnglish: "Dye vats were discovered at archaeological sites including Uraiyur (near Tiruchirappalli), which was a major ancient dyeing and textile centre. Also in Kaveripoompattinam (Puhar) and other Sangam-era sites. These vats confirm that organized dyeing of cloth with natural dyes was practised in ancient Tamil Nadu.",
    answerTamil: "சாயத்தொட்டிகள் உறையூர் (திருச்சிராப்பள்ளி அருகே) போன்ற தொல்லியல் களங்களில் கண்டெடுக்கப்பட்டன. இது சங்க காலத்தில் ஒரு முக்கிய நெசவு மற்றும் சாயமிடல் மையமாக இருந்தது. காவேரிப்பூம்பட்டினம் (புகார்) போன்ற இடங்களிலும் கண்டெடுக்கப்பட்டன.",
    keywordsEnglish: ["dye vats", "Uraiyur", "Kaveripoompattinam", "dyeing", "archaeological"],
    keywordsTamil: ["சாயத்தொட்டி", "உறையூர்", "காவேரிப்பூம்பட்டினம்", "சாயமிடல்", "தொல்லியல்"],
  },
  {
    ...
    answerEnglish: "In Madurai, Black and Red Ware (கருப்பு சிவப்பு மட்பாண்டம்) pottery was very popular and widely found. These distinctively fired pots have a black interior and upper exterior with a red lower exterior, created by an inverted firing technique. They are associated with Iron Age and early historic Tamil culture.",
    answerTamil: "மதுரையில் கருப்பு சிவப்பு மட்பாண்டங்கள் (Black and Red Ware) மிகவும் பிரசித்தமாக இருந்தன. இந்த மட்பாண்டங்கள் தலைகீழாக சூளையில் சுடப்படுவதால் உள்பகுதி மற்றும் மேல் வெளிப்பகுதி கருப்பாகவும் கீழ் வெளிப்பகுதி சிவப்பாகவும் இருக்கும். இவை இரும்பு காலம் மற்றும் ஆரம்பகால தமிழ் பண்பாட்டோடு தொடர்புடையவை.",
    keywordsEnglish: ["Black and Red Ware", "Madurai", "Iron Age", "inverted firing", "pottery"],
    keywordsTamil: ["கருப்பு சிவப்பு மட்பாண்டம்", "மதுரை", "இரும்பு காலம்", "தலைகீழ் சுடுமுறை"],
  },
  {
    ...
    answerEnglish: "Velloor Karigiri pottery (near Vellore) is known for its fine black polished surface and thin walls, indicating skilled craftsmanship. These pots are characterized by their smooth burnished finish achieved by rubbing the surface before firing. They represent a high level of technological advancement in ancient Tamil pottery tradition.",
    answerTamil: "வேலூர் கரிகிரி மட்பாண்டங்கள் அவற்றின் மெல்லிய மற்றும் நேர்த்தியான கருப்பு பளபளப்பான மேற்பரப்பிற்காக பிரசித்தி பெற்றவை. சுடுவதற்கு முன் மேற்பரப்பை தேய்த்து மெருகூட்டும் தொழில்நுட்பத்தால் இந்த பளபளப்பு கிடைக்கிறது. இவை பண்டைய தமிழ் மட்கலை தொழில்நுட்பத்தின் உயர் நிலையை பிரதிபலிக்கின்றன.",
    keywordsEnglish: ["Velloor", "Karigiri", "black polished", "burnished", "fine walls", "pottery"],
  ...
  },
  {
    ...
    answerEnglish: "The two main divisions of pottery are: (1) Glazed pottery (மெருகூட்டப்பட்ட மட்பாண்டம்) – has a shiny, glass-like coating applied before or after firing, making it waterproof and decorative; (2) Unglazed pottery (மெருகூட்டப்படாத மட்பாண்டம்) – plain, without any coating, usually porous and used for everyday utility purposes.",
    answerTamil: "மட்பாண்டங்களின் இரண்டு பிரிவுகள்: (1) மெருகூட்டப்பட்ட மட்பாண்டம் (Glazed) – கண்ணாடி போன்ற பளபளப்பான பூச்சு கொண்டது, நீர் ஊடுருவாது; (2) மெருகூட்டப்படாத மட்பாண்டம் (Unglazed) – எந்த பூச்சும் இல்லாதது, நிறைய துளைகள் உடையது, அன்றாட பயன்பாட்டிற்கு பயன்படுத்தப்பட்டது.",
    keywordsEnglish: ["glazed", "unglazed", "pottery", "coating", "waterproof"],
    keywordsTamil: ["மெருகூட்டப்பட்ட", "மெருகூட்டப்படாத", "மட்பாண்டம்", "பூச்சு"],
  },
  {
    ...
    answerEnglish: "Craft work on pottery (நுண்கலைப் படைப்பு) refers to the artistic decoration applied on clay pots. It includes incised designs (கீறல் வடிவங்கள்), painted motifs, impressed patterns, modelled figures, and relief work. These decorations express cultural, religious, and aesthetic values of the potter and the society they belonged to.",
    answerTamil: "மண்பாண்டங்களில் நுண்கலைப் படைப்பு என்பது களிமண் பாத்திரங்களில் செய்யப்படும் கலைகூறு அலங்காரங்களை குறிக்கும். இதில் கீறல் வடிவங்கள், வர்ணம் பூசிய உருவங்கள், அழுத்திய வடிவங்கள் மற்றும் சிற்பக்கலை வேலைப்பாடுகள் அடங்கும். இவை குயவர்களின் கலாச்சார, மத மற்றும் அழகியல் மதிப்புகளை வெளிப்படுத்துகின்றன.",
    keywordsEnglish: ["incised designs", "painted motifs", "relief work", "decoration", "pottery art"],
    keywordsTamil: ["கீறல் வடிவங்கள்", "வர்ண ஓவியம்", "அலங்காரம்", "மட்கலை"],
  },
  {
    ...
    answerEnglish: "Pottery in educational art is used to: (1) develop creativity and fine motor skills in students; (2) teach history and archaeology through ancient pottery analysis; (3) promote traditional crafts as part of cultural heritage education; (4) serve as a medium for artistic expression, design, and sculpture in art courses.",
    answerTamil: "கல்வி கலையில் மட்கலையின் பயன்கள்: (1) மாணவர்களின் படைப்பாற்றல் மற்றும் நுட்பமான திறன்களை வளர்க்கிறது; (2) பண்டைய மட்பாண்டங்கள் மூலம் வரலாறு மற்றும் தொல்லியலை கற்பிக்கிறது; (3) கலாச்சார பாரம்பரிய கல்வியில் பாரம்பரிய கைவினைகளை மேம்படுத்துகிறது; (4) கலைப் பாடங்களில் வடிவமைப்பு மற்றும் சிற்பத்திற்கான ஊடகமாக செயல்படுகிறது.",
    keywordsEnglish: ["creativity", "fine motor skills", "archaeology", "cultural heritage", "art medium"],
    keywordsTamil: ["படைப்பாற்றல்", "திறன்கள்", "தொல்லியல்", "கலாச்சார பாரம்பரியம்"],
  },
  {
    ...
    answerEnglish: "Pottery in medical science: (1) Clay pots store water and keep it cool, preventing bacterial growth; (2) Unglazed earthenware pots are used to store herbal medicines and oils; (3) Archaeological pottery residue analysis helps identify ancient diets and diseases; (4) Clay therapy (pelotherapy) uses medicinal clay for skin treatments and healing.",
    answerTamil: "மருத்துவத்தில் மட்கலையின் பயன்கள்: (1) களிமண் பாத்திரங்கள் நீரை குளிர்ச்சியாக வைத்திருந்து நுண்ணுயிர் வளர்ச்சியை தடுக்கின்றன; (2) மூலிகை மருந்துகள் மற்றும் எண்ணெய்களை சேமிக்க பயன்படுகின்றன; (3) மட்பாண்ட எச்சங்களை பகுப்பாய்வு செய்வதன் மூலம் பண்டைய உணவுப் பழக்கங்களை அறியலாம்; (4) களிமண் சிகிச்சை தோல் நோய்களுக்கு பயன்படுகிறது.",
    keywordsEnglish: ["cool water", "herbal medicine", "clay therapy", "residue analysis", "healing"],
    keywordsTamil: ["குளிர்ந்த நீர்", "மூலிகை மருந்து", "களிமண் சிகிச்சை", "மட்பாண்ட எச்சம்"],
  },
  {
    ...
    answerEnglish: "Black and Red Ware (BRW) pots commonly contain: iron objects (weapons, tools), beads (glass, carnelian, gold), coins, grains, and animal bones. These were often found as burial urns with grave goods. Their presence reveals the Iron Age economy, trade connections, and burial customs of ancient Tamils.",
    answerTamil: "கருப்பு சிவப்பு மட்பாண்டங்களில் பொதுவாக கண்டெடுக்கப்படுவை: இரும்பு பொருட்கள் (ஆயுதங்கள், கருவிகள்), மணிகள் (கண்ணாடி, கோமேதகம், தங்கம்), நாணயங்கள், தானியங்கள் மற்றும் விலங்கு எலும்புகள். இவை பெரும்பாலும் இடுகாட்டு கலசங்களாக கிடைக்கின்றன. இரும்பு கால வணிகம் மற்றும் அடக்கம் செய்யும் பழக்கங்களை வெளிப்படுத்துகின்றன.",
    keywordsEnglish: ["iron objects", "beads", "burial urns", "grave goods", "Iron Age"],
    keywordsTamil: ["இரும்பு பொருட்கள்", "மணிகள்", "இடுகாட்டு கலசம்", "இரும்பு காலம்"],
  },
  {
    ...
    answerEnglish: "Pottery symbols include: (1) Swastika (ஸ்வஸ்திக) – auspicious symbol; (2) Fish (மீன்) – symbol of Pandya dynasty; (3) Geometric patterns – circles, lines, dots; (4) Graffiti marks (கீறல் குறிகள்) – possibly ownership or trade marks; (5) Sun and star motifs. These symbols carry religious, political, and commercial significance.",
    answerTamil: "மட்பாண்டங்களில் காணப்படும் குறியீடுகள்: (1) ஸ்வஸ்திக – மங்கல சின்னம்; (2) மீன் – பாண்டிய அரசின் சின்னம்; (3) வடிவியல் வடிவங்கள் – வட்டங்கள், கோடுகள், புள்ளிகள்; (4) கீறல் குறிகள் – உரிமை அல்லது வணிக குறிகளாக இருக்கலாம்; (5) சூரியன் மற்றும் நட்சத்திர வடிவங்கள். இவை மத, அரசியல் மற்றும் வணிக முக்கியத்துவம் வாய்ந்தவை.",
    keywordsEnglish: ["swastika", "fish symbol", "graffiti marks", "geometric patterns", "Pandya"],
    keywordsTamil: ["ஸ்வஸ்திக", "மீன் சின்னம்", "கீறல் குறிகள்", "வடிவியல் வடிவம்", "பாண்டியர்"],
  },
  {
    ...
    answerEnglish: "Pots bearing the Swastika symbol were found at sites in various parts of Tamil Nadu, notably at Adichanallur (Tirunelveli district) and Kodumanal (Erode district). These archaeological sites have yielded Iron Age urns and pottery with incised Swastika and other auspicious symbols, indicating their religious significance in ancient Tamil society.",
    answerTamil: "ஸ்வஸ்திக குறியீடு கொண்ட மட்பாண்டங்கள் தமிழகத்தில் குறிப்பாக ஆதிச்சநல்லூர் (திருநெல்வேலி மாவட்டம்) மற்றும் கோடுமணல் (ஈரோடு மாவட்டம்) போன்ற தொல்லியல் களங்களில் கண்டெடுக்கப்பட்டன. இவை இரும்பு காலத்தைச் சேர்ந்த இடுகாட்டு கலசங்களில் காணப்படுகின்றன.",
    keywordsEnglish: ["Adichanallur", "Kodumanal", "Swastika", "Iron Age urns", "Tirunelveli"],
    keywordsTamil: ["ஆதிச்சநல்லூர்", "கோடுமணல்", "ஸ்வஸ்திக", "இரும்பு காலம்", "திருநெல்வேலி"],
  },
  {
    ...
    answerEnglish: "People used symbols to express their thoughts from prehistoric times (Neolithic and Chalcolithic periods) onwards. In Tamil Nadu, symbols are found from the Iron Age (1000–300 BCE) through the Sangam period. Graffiti marks on Sangam-era pottery indicate early attempts at written communication before the formal development of the Tamil script.",
    answerTamil: "மக்கள் தங்கள் எண்ணங்களை வெளிப்படுத்த குறியீடுகளை வரலாற்றுக்கு முந்தைய காலம் (நவீன கற்காலம் மற்றும் செம்பு-கற்காலம்) முதலே பயன்படுத்தி வந்தனர். தமிழகத்தில் இரும்பு காலம் (கி.மு. 1000–300) முதல் சங்க காலம் வரை குறியீடுகள் காணப்படுகின்றன. முறையான தமிழ் எழுத்தமைப்பு வருவதற்கு முன்பே மட்பாண்டங்களில் கீறல் குறிகள் காணப்படுகின்றன.",
    keywordsEnglish: ["prehistoric", "Iron Age", "Sangam period", "graffiti marks", "symbols", "written communication"],
...
முக்கிய சொற்கள்: Co-optex, GI தகவல்கள், காஞ்சிபுரம் பட்டு, ASI, கீழடி, மட்கலை, ஆவணப்படுத்தல், யுனெஸ்கோ`,
  ...
  // ─── UNIT II ───
  {
    ...
    answerEnglish: "Architecture is the art and science of designing and constructing buildings and other physical structures. It involves planning, design aesthetics, structural engineering, and construction techniques. In Tamil context, it includes temple architecture (கோவில் கட்டடக்கலை), palace construction, fortifications, and civic structures developed across different dynasties.",
    answerTamil: "கட்டடக்கலை என்பது கட்டடங்களையும் பிற இயற்பியல் கட்டமைப்புகளையும் வடிவமைத்து கட்டுவதற்கான கலை மற்றும் அறிவியலாகும். இதில் திட்டமிடல், வடிவமைப்பு அழகியல், கட்டமைப்பு பொறியியல் மற்றும் கட்டுமான தொழில்நுட்பங்கள் அடங்கும். தமிழ் சூழலில் கோவில் கட்டடக்கலை, அரண்மனை கட்டுமானம் மற்றும் கோட்டைகள் அடங்கும்.",
    keywordsEnglish: ["architecture", "design", "construction", "temple", "structural engineering"],
  ...
  },
  {
    ...
    answerEnglish: "Construction materials in the Sangam period included: (1) Stone (கல்) – for temples and hero stones; (2) Brick (செங்கல்) – sun-dried and kiln-fired; (3) Timber/Wood (மரம்) – for pillars, beams, and roofs; (4) Clay and mud (மண்) – for walls; (5) Thatched grass and leaves (கூரை) – for roofing. Lime mortar was used as binding agent.",
    answerTamil: "சங்க காலத்தில் பயன்படுத்தப்பட்ட கட்டுமானப் பொருட்கள்: (1) கல் – கோவில்கள் மற்றும் நடுகற்களுக்கு; (2) செங்கல் – சூரிய ஒளியில் காய்ந்த மற்றும் சூளையில் சுட்ட; (3) மரம் – தூண்கள், உத்திரங்கள் மற்றும் கூரைகளுக்கு; (4) களிமண் மற்றும் மண் – சுவர்களுக்கு; (5) புல் மற்றும் இலைகள் – கூரைக்கு. சுண்ணாம்பு சாந்து பிணைப்பு பொருளாக பயன்படுத்தப்பட்டது.",
    keywordsEnglish: ["stone", "brick", "timber", "clay", "lime mortar", "Sangam period"],
  ...
  },
  {
    ...
    answerEnglish: "Tamil-Brahmi script (தமிழ்-பிராமி எழுத்து) and later Tamil script (வட்டெழுத்து / Tamil script) are predominantly found on hero stones (நடுகல்) in Tamil Nadu. These inscriptions record the name of the warrior, his battle achievements, the king he served, and the village that erected the stone in his honor.",
    answerTamil: "தமிழகத்தில் கண்டெடுக்கப்பட்ட நடுகற்களில் தமிழ்-பிராமி எழுத்தும் பிறகு தமிழ் எழுத்தும் (வட்டெழுத்து) பெரும்பாலும் காணப்படுகின்றன. இந்த கல்வெட்டுகளில் வீரனின் பெயர், போர் சாதனைகள், அவன் சேவை செய்த அரசன் மற்றும் அவனை கௌரவிக்க கல் நட்ட கிராமம் பற்றிய தகவல்கள் பதிவாகியுள்ளன.",
    keywordsEnglish: ["Tamil-Brahmi", "Vatteluttu", "hero stone", "inscription", "warrior"],
    keywordsTamil: ["தமிழ்-பிராமி", "வட்டெழுத்து", "நடுகல்", "கல்வெட்டு", "வீரன்"],
  },
  {
    unit: "Unit II", qNo: 4, marks: 2,
    questionEnglish: "What are moats?",
    questionTamil: "அகழிகள் என்றால் என்ன?",
    answerEnglish: "Moats (அகழி) are deep, wide water-filled ditches dug around a fort, castle, or fortified city to serve as a defensive barrier against enemy attacks. In ancient Tamil Nadu, fortifications typically had moats surrounding the walls. They prevented enemy troops from directly attacking the walls and also served as a water source during sieges.",
    answerTamil: "அகழிகள் என்பது கோட்டை, அரண்மனை அல்லது கோட்டை நகரத்தை சுற்றி தோண்டப்பட்ட ஆழமான, அகன்ற நீர் நிரம்பிய குழிகளாகும். இவை எதிரி தாக்குதல்களுக்கு எதிரான பாதுகாப்பு தடையாக செயல்படுகின்றன. பண்டைய தமிழகத்தில் கோட்டைகளை சுற்றி அகழிகள் இருந்தன. இவை எதிரிகளை நேரடியாக சுவரை தாக்குவதை தடுத்தன.",
    keywordsEnglish: ["moat", "defense", "fort", "water barrier", "siege"],
    keywordsTamil: ["அகழி", "பாதுகாப்பு", "கோட்டை", "நீர் தடை", "முற்றுகை"],
  },
  {
    ...
    answerEnglish: "The main styles of temple architecture in India are: (1) Nagara style (North India) – characterized by a curvilinear shikhara tower; (2) Dravidian style (South India) – characterized by a pyramidal gopuram tower; (3) Vesara style (Deccan) – a hybrid of Nagara and Dravidian; (4) Rock-cut temples – carved out of living rock (Mahabalipuram); (5) Cave temples (குகைக் கோவில்).",
    answerTamil: "இந்திய கோவில் கட்டடக்கலையின் முக்கிய பாணிகள்: (1) நாகர பாணி (வட இந்தியா) – வளைந்த சிகரம்; (2) திராவிட பாணி (தென்னிந்தியா) – கூர்நுனி கோபுரம்; (3) வேசர பாணி (தக்காணம்) – நாகர மற்றும் திராவிட கலவை; (4) பாறைகளில் கொத்தப்பட்ட கோவில் (மாமல்லபுரம்); (5) குகைக் கோவில்கள்.",
    keywordsEnglish: ["Nagara", "Dravidian", "Vesara", "rock-cut", "gopuram", "shikhara"],
    keywordsTamil: ["நாகர பாணி", "திராவிட பாணி", "வேசர பாணி", "பாறைக் கோவில்", "கோபுரம்"],
  },
  {
    ...
    answerEnglish: "The Ranganathaswamy Temple at Srirangam (Tiruchirappalli) has the Rajagopuram which is considered the tallest temple gopuram in Tamil Nadu and one of the tallest in Asia, standing approximately 73 metres (239 feet) tall. It is a magnificent example of Dravidian temple architecture built over several centuries.",
    answerTamil: "திருச்சிராப்பள்ளியில் உள்ள ஸ்ரீரங்கம் ரங்கநாதசுவாமி கோவிலின் ராஜகோபுரம் தமிழகத்தில் மிக உயர்ந்த கோவில் கோபுரமாக கருதப்படுகிறது. இது ஆசியாவிலேயே மிக உயர்ந்தவற்றில் ஒன்றாகும் – சுமார் 73 மீட்டர் (239 அடி) உயரம் கொண்டது. இது பல நூற்றாண்டுகளாக கட்டப்பட்ட திராவிட கட்டடக்கலையின் அற்புதமான எடுத்துக்காட்டாகும்.",
    keywordsEnglish: ["Srirangam", "Rajagopuram", "73 metres", "Dravidian", "Ranganathaswamy"],
    keywordsTamil: ["ஸ்ரீரங்கம்", "ராஜகோபுரம்", "73 மீட்டர்", "திராவிட பாணி", "ரங்கநாதசுவாமி"],
  },
  {
    ...
    answerEnglish: "Tholkappiyar in his Tholkappiyam describes six stages of commemorating a hero with a hero stone (நடுகல்): (1) Choosing a suitable stone; (2) Bathing the stone in ritually pure water; (3) Establishing the stone in an appropriate place; (4) Inscribing the warrior's deeds; (5) Worshipping the stone as a deity; (6) Performing worship and festivals in the hero's honor.",
    answerTamil: "தொல்காப்பியம் நடுகல் நட்டு வீரனை கௌரவிக்கும் ஆறு படிநிலைகளை விவரிக்கிறது: (1) தகுந்த கல்லை தேர்ந்தெடுத்தல்; (2) கல்லை சடங்கு முறையில் நீரில் குளிப்பாட்டுதல்; (3) பொருத்தமான இடத்தில் கல்லை நிலைநாட்டுதல்; (4) வீரனின் சாதனைகளை கல்லில் பொறித்தல்; (5) கல்லை தெய்வமாக வழிபடுதல்; (6) வீரனின் நினைவில் வழிபாடு மற்றும் விழாக்கள் நடத்துதல்.",
    keywordsEnglish: ["Tholkappiyar", "hero stone", "six stages", "commemoration", "worship"],
    keywordsTamil: ["தொல்காப்பியர்", "நடுகல்", "ஆறு நிலைகள்", "கௌரவிப்பு", "வழிபாடு"],
  },
  {
    ...
    answerEnglish: "Grand temples built by the Cholas include: (1) Brihadeeswara Temple, Thanjavur – built by Raja Raja Chola I (1010 CE); (2) Gangaikonda Cholapuram Temple – built by Rajendra Chola I; (3) Airavateswarar Temple, Darasuram – built by Raja Raja Chola II. All three are UNESCO World Heritage Sites known as the 'Great Living Chola Temples'.",
    answerTamil: "சோழர்கள் கட்டிய பெருங்கோயில்கள்: (1) தஞ்சாவூர் பிரகதீஸ்வரர் கோவில் – ராஜ ராஜ சோழன் I (கி.பி. 1010); (2) கங்கைகொண்ட சோழபுரம் கோவில் – ராஜேந்திர சோழன் I; (3) தாரசுரம் ஐராவதேஸ்வரர் கோவில் – ராஜ ராஜ சோழன் II. இந்த மூன்றும் யுனெஸ்கோ உலக பாரம்பரிய தளங்கள் – 'பெரிய வாழும் சோழர் கோவில்கள்' என அழைக்கப்படுகின்றன.",
    keywordsEnglish: ["Brihadeeswara", "Gangaikonda Cholapuram", "Airavateswarar", "UNESCO", "Raja Raja Chola"],
    keywordsTamil: ["பிரகதீஸ்வரர்", "கங்கைகொண்ட சோழபுரம்", "ஐராவதேஸ்வரர்", "யுனெஸ்கோ", "ராஜ ராஜ சோழன்"],
  },
  {
    ...
    answerEnglish: "Thirumalai Nayakkar Palace in Madurai was built in 1636 CE by King Thirumalai Nayak. It is a magnificent example of Dravidian and Italian architectural fusion. The palace features massive pillars (each about 12 metres high), a large courtyard (Swarga Vilasam), audience hall, and ornate stucco work. Today it is a tourist attraction with a sound-and-light show.",
    answerTamil: "மதுரையில் உள்ள திருமலை நாயக்கர் அரண்மனை 1636 ஆம் ஆண்டு திருமலை நாயக்கரால் கட்டப்பட்டது. இது திராவிட மற்றும் இத்தாலிய கட்டடக்கலை கலவையின் சிறந்த எடுத்துக்காட்டு. கட்டடத்தில் பிரமாண்டமான தூண்கள் (ஒவ்வொன்றும் சுமார் 12 மீட்டர் உயரம்), பெரிய திறந்தவெளி (ஸ்வர்க்க விலாசம்), மன்றம் மற்றும் சுண்ணாம்பு சுதை வேலைப்பாடுகள் உள்ளன. இன்று இது ஒலி மற்றும் ஒளி நிகழ்ச்சியுடன் பயணி ஈர்ப்பிடமாக உள்ளது.",
    keywordsEnglish: ["Thirumalai Nayak", "1636 CE", "Madurai", "Dravidian", "Italian", "Swarga Vilasam"],
    keywordsTamil: ["திருமலை நாயக்கர்", "1636 ஆம் ஆண்டு", "மதுரை", "திராவிட", "இத்தாலிய", "ஸ்வர்க்க விலாசம்"],
  },
  {
    ...
    answerEnglish: "The Shore Temple at Mahabalipuram (Mamallapuram) was built by Pallava king Narasimhavarman II (Rajasimha) around 700–728 CE. It is one of the oldest structural stone temples in South India and a UNESCO World Heritage Site. The temple is dedicated to Lord Shiva and faces the Bay of Bengal.",
    answerTamil: "மாமல்லபுரம் கடற்கரைக் கோயில் பல்லவ அரசன் நரசிம்மவர்மன் II (ராஜசிம்மன்) கி.பி. 700–728 ஆம் ஆண்டு கட்டினார். இது தென்னிந்தியாவின் மிகவும் பழமையான கல் கட்டிடக் கோவில்களில் ஒன்றும் யுனெஸ்கோ உலக பாரம்பரிய தளமும் ஆகும். கோவில் சிவபெருமானுக்கு அர்ப்பணிக்கப்பட்டது, வங்காள விரிகுடாவை பார்க்கும் திசையில் கட்டப்பட்டது.",
    keywordsEnglish: ["Shore Temple", "Narasimhavarman II", "Pallava", "700 CE", "UNESCO", "Shiva"],
    keywordsTamil: ["கடற்கரைக் கோவில்", "நரசிம்மவர்மன் II", "பல்லவர்", "யுனெஸ்கோ", "சிவன்"],
  },
  {
    ...
    answerEnglish: "Mahabalipuram is also known as: (1) Mamallapuram – named after Pallava king Mamalla (Narasimhavarman I); (2) Seven Pagodas – European sailors referred to it because of its many coastal temples; (3) Pallava port – as it served as the main seaport of the Pallava kingdom. Today it is officially called Mamallapuram.",
    answerTamil: "மாமல்லபுரத்தின் வேறு பெயர்கள்: (1) மாமல்லபுரம் – பல்லவ அரசன் மாமல்லன் (நரசிம்மவர்மன் I) பெயரில் அமைந்தது; (2) ஏழு கோபுரங்கள் (Seven Pagodas) – ஐரோப்பிய மாலுமிகள் கடற்கரை கோவில்கள் காரணமாக அழைத்தனர்; (3) பல்லவ துறைமுகம் – பல்லவ அரசின் முக்கிய துறைமுகமாக திகழ்ந்தது. இன்று அதிகாரப்பூர்வமாக மாமல்லபுரம் என அழைக்கப்படுகிறது.",
    keywordsEnglish: ["Mamallapuram", "Seven Pagodas", "Pallava port", "Narasimhavarman I"],
    keywordsTamil: ["மாமல்லபுரம்", "ஏழு கோபுரங்கள்", "பல்லவ துறைமுகம்", "நரசிம்மவர்மன் I"],
  },
  {
    unit: "Unit II", qNo: 12, marks: 2,
    questionEnglish: "What is the Pancha Pandava Rathas?",
    questionTamil: "பஞ்சபாண்டவர்கள் இரதங்கள் யாவை?",
    answerEnglish: "The Pancha Pandava Rathas (Five Rathas) at Mahabalipuram are five monolithic rock-cut temple chariots carved during the reign of Pallava king Narasimhavarman I (7th century CE). Each ratha is named after the Pandava brothers: Dharmaraja, Bhima, Arjuna, Nakula-Sahadeva, and Draupadi Ratha. They represent different styles of Dravidian temple architecture.",
    answerTamil: "மாமல்லபுரத்திலுள்ள பஞ்சபாண்டவர் இரதங்கள் பல்லவ அரசன் நரசிம்மவர்மன் I ஆட்சியில் (கி.பி. 7ஆம் நூற்றாண்டு) ஒரே பாறையில் கொத்தப்பட்ட ஐந்து கோவில் தேர்களாகும். ஒவ்வொரு தேரும் பாண்டவ சகோதரர்களின் பெயரில் அழைக்கப்படுகின்றன: தர்மராஜ, பீம, அர்ஜுன, நகுல-சகாதேவ மற்றும் திரௌபதி. இவை திராவிட கோவில் கட்டடக்கலையின் பல்வேறு பாணிகளை பிரதிபலிக்கின்றன.",
    keywordsEnglish: ["Five Rathas", "Mahabalipuram", "Narasimhavarman I", "monolithic", "Pallava", "Pandavas"],
    keywordsTamil: ["ஐந்து தேர்கள்", "மாமல்லபுரம்", "நரசிம்மவர்மன் I", "ஒரே பாறை", "பல்லவர்", "பாண்டவர்கள்"],
  },
  {
    unit: "Unit II", qNo: 13, marks: 2,
    questionEnglish: "What is a rock-cut cave temple?",
    questionTamil: "குடைரைக் கோவில் என்றால் என்ன?",
    answerEnglish: "A rock-cut cave temple (குடைவரைக் கோவில்) is a temple carved or excavated directly into a natural rock face or hillside, without any separate construction. The entire structure — pillars, halls, and sanctum — is cut from a single mass of rock. Famous examples in Tamil Nadu include the Pallava cave temples at Mahabalipuram, Mahaendra cave at Mahendravadi, and Trichy Rock Fort.",
    answerTamil: "குடைவரைக் கோவில் என்பது இயற்கையான பாறை அல்லது மலை பக்கத்தில் நேரடியாக கொத்தி வெட்டி அமைக்கப்பட்ட கோவில் ஆகும், தனிப்பட்ட கட்டுமான வேலை இல்லாமல். தூண்கள், மண்டபங்கள் மற்றும் கருவறை ஆகியவை ஒரே பாறையிலிருந்து வெட்டப்படுகின்றன. தமிழகத்தில் மாமல்லபுரம் பல்லவர் குடைவரை கோவில்கள், மகேந்திரவாடி, திருச்சி கல்லணை கோவில் பிரபலமான எடுத்துக்காட்டுகள்.",
    keywordsEnglish: ["rock-cut", "cave temple", "Pallava", "Mahabalipuram", "carved from rock"],
    keywordsTamil: ["குடைவரை", "குகைக் கோவில்", "பல்லவர்", "மாமல்லபுரம்", "பாறையில் கொத்தப்பட்டது"],
  },
  {
    ...
    answerEnglish: "The 'Aayiram Kaal Mandapam' (Thousand-Pillared Hall) in the Madurai Meenakshi Amman Temple was built by the Nayak rulers, specifically attributed to Ariyappa Nayak (or Viswanatha Nayak) during the 16th century CE. The hall has 985 richly sculpted pillars (not exactly 1000) and is now used as an art museum.",
    answerTamil: "மதுரை மீனாட்சி அம்மன் கோவிலின் ஆயிரங்கால் மண்டபத்தை நாயக்கர் ஆட்சியாளர்கள், குறிப்பாக அரியப்ப நாயக்கர் (அல்லது விஸ்வநாத நாயக்கர்) கி.பி. 16ஆம் நூற்றாண்டில் கட்டினார். மண்டபத்தில் 985 அழகிய சிற்பங்கள் கொண்ட தூண்கள் உள்ளன (சரியாக 1000 இல்லை). இன்று இது கலை அருங்காட்சியகமாக பயன்படுத்தப்படுகிறது.",
    keywordsEnglish: ["Thousand Pillars", "Nayak", "16th century", "985 pillars", "Madurai", "Meenakshi"],
    keywordsTamil: ["ஆயிரங்கால் மண்டபம்", "நாயக்கர்", "985 தூண்கள்", "மதுரை", "மீனாட்சி"],
  },
  {
    ...
    answerEnglish: "Indo-Saracenic architecture is a hybrid architectural style developed during British colonial rule in India (19th–20th century). It combines Indian (Mughal, Rajput, Dravidian) with Islamic (Saracenic) and European Gothic elements. Features include: domes, arches, minarets, verandahs, and pointed windows. Examples: Madras High Court, Victoria Memorial (Kolkata), Chennai Central Railway Station.",
    answerTamil: "இந்தோ-சாரசனிக் கட்டடக்கலை என்பது பிரிட்டிஷ் காலனிய ஆட்சியில் (19–20ஆம் நூற்றாண்டு) உருவான கலப்பு கட்டடக்கலை பாணி ஆகும். இது இந்திய (முகலாயம், ராஜபுத்திரம், திராவிடம்), இஸ்லாமிய (சாரசனிக்) மற்றும் ஐரோப்பிய கோதிக் கூறுகளை ஒருங்கிணைக்கிறது. சிறப்பியல்புகள்: குவிமாடங்கள், வளைவுகள், மினாரெட்கள், மாடிகள். எடுத்துக்காட்டுகள்: சென்னை உயர் நீதிமன்றம், சென்னை மத்திய இரயில் நிலையம்.",
    keywordsEnglish: ["Indo-Saracenic", "British colonial", "domes", "arches", "Madras High Court", "hybrid"],
    keywordsTamil: ["இந்தோ-சாரசனிக்", "பிரிட்டிஷ் காலம்", "குவிமாடங்கள்", "வளைவுகள்", "சென்னை உயர் நீதிமன்றம்"],
  },
  {
...
முக்கிய சொற்கள்: மாமல்லபுரம், கடற்கரைக் கோவில், மகிஷாசுரமர்த்தினி, வராக குகை, பல்லவர், நரசிம்மவர்மன், யுனெஸ்கோ, அர்ஜுன தவம்`,
  ...
  // ─── UNIT III ───
  {
    ...
    answerEnglish: "Rafters (construction beams used in shipbuilding and buildings) are known by several names in Tamil: Kaddu maram (கட்டுமரம்), Thoni maram (தோணி மரம்), Kappal maram (கப்பல் மரம்). In English, they are also called 'catamarans' – a word derived from Tamil 'kattumaram' (tied logs). Teak, rosewood, and palmyra were commonly used timbers.",
    answerTamil: "கட்டுமரங்கள் பல பெயர்களில் அழைக்கப்படுகின்றன: கட்டுமரம், தோணி மரம், கப்பல் மரம். ஆங்கிலத்தில் 'catamaran' என்ற சொல் தமிழ் 'கட்டுமரம்' (கட்டப்பட்ட மரங்கள்) என்ற சொல்லிலிருந்து வந்தது. தேக்கு, வேங்கை மற்றும் பனை மரங்கள் பொதுவாக பயன்படுத்தப்பட்டன.",
    keywordsEnglish: ["kattumaram", "catamaran", "teak", "rafters", "shipbuilding"],
  ...
  },
  {
    ...
    answerEnglish: "Sangam literature mentions various types of watercraft: (1) Kattumaram – log raft for fishing; (2) Thoni – small boat for river/inland transport; (3) Padagu – medium-sized vessel; (4) Kappal – large ocean-going ship for trade. Overall, Sangam texts reference approximately six to seven types of watercraft suited for different purposes from fishing to ocean trade.",
    answerTamil: "சங்க இலக்கியங்கள் பல வகை நீர்ப்போக்குவரத்து கலங்களை குறிப்பிடுகின்றன: (1) கட்டுமரம் – மீன்பிடி மிதவை; (2) தோணி – ஆறு/நிலப்பகுதி போக்குவரத்திற்கு சிறிய படகு; (3) படகு – நடுத்தர அளவிலான கப்பல்; (4) கப்பல் – வணிகத்திற்கான பெரிய கடல்சாரி கப்பல். மொத்தத்தில் சங்க நூல்களில் சுமார் ஆறு முதல் ஏழு வகையான கலங்கள் குறிப்பிடப்படுகின்றன.",
    keywordsEnglish: ["kattumaram", "thoni", "padagu", "kappal", "Sangam", "watercraft"],
  ...
  },
  {
    ...
    answerEnglish: "Parathavar (பரதர்) were the ancient Tamil maritime community who lived along the coastal regions (Neythal நெய்தல் landscape). They were skilled fishermen, sailors, pearl divers, and seafarers. They played a crucial role in the ancient maritime trade of Tamil Nadu, operating fishing boats (kattumaram) and larger trade vessels. They are still found in coastal Tamil Nadu and Sri Lanka.",
    answerTamil: "பரதர் என்பவர் கடலோர பகுதிகளில் (நெய்தல் நிலம்) வாழ்ந்த பண்டைய தமிழ் கடல்சார் சமூகத்தினர் ஆவர். இவர்கள் திறன்வாய்ந்த மீனவர்கள், மாலுமிகள், முத்து குளிப்பவர்கள் மற்றும் கடலோடிகளாக இருந்தனர். தமிழகத்தின் பண்டைய கடல்வாணிகத்தில் முக்கிய பங்கு வகித்தனர். இன்றும் கடலோர தமிழகம் மற்றும் இலங்கையில் காணப்படுகிறார்கள்.",
    keywordsEnglish: ["Parathavar", "fishermen", "maritime", "pearl diving", "Neythal", "coastal"],
    keywordsTamil: ["பரதர்", "மீனவர்", "கடல்சார்", "முத்து குளிப்பு", "நெய்தல்", "கடலோர"],
  },
  {
    ...
    answerEnglish: "Bipolar electric discharge is an ancient technique for working beads and gemstones. In this method, a stone or mineral is placed between two metal electrodes. An electric current (or spark) is applied, causing the material to fracture or chip along natural planes. This technique was used by ancient artisans in Kodumanal to split carnelian, quartz, and other hard stones for bead manufacturing.",
    answerTamil: "இருமுனை மின் இறக்கம் என்பது மணிகள் மற்றும் இரத்தினக்கற்களை செயலாக்குவதற்கான பண்டைய தொழில்நுட்பம். இந்த முறையில் ஒரு கல் அல்லது தாது இரண்டு உலோக மின்முனைகளுக்கு இடையே வைக்கப்படுகிறது. மின்னோட்டம் அல்லது தீப்பொறி செலுத்தப்படுவதால் பொருள் இயற்கை தளங்களில் வெடிக்கும் அல்லது உடைக்கும். கோடுமணலில் பண்டைய கைவினைஞர்கள் கோமேதகம், குவார்ட்ஸ் போன்ற கடினமான கற்களை மணிகள் தயாரிக்க இந்த முறையில் பிளந்தனர்.",
    keywordsEnglish: ["bipolar", "electric discharge", "bead making", "Kodumanal", "carnelian", "stone splitting"],
    keywordsTamil: ["இருமுனை", "மின் இறக்கம்", "மணி செய்தல்", "கோடுமணல்", "கோமேதகம்"],
  },
  {
    unit: "Unit III", qNo: 5, marks: 2,
    questionEnglish: "Write about ancient smelting furnaces.",
    questionTamil: "உலைக்களம் பற்றி எழுதுக.",
    answerEnglish: "Ancient smelting furnaces (உலைக்களம்) were structures used to extract metals from ores by applying high heat. In ancient Tamil Nadu, iron smelting furnaces were found at Kodumanal, Adichanallur, and Tamil Nadu hill regions. They used clay-built furnaces with bellows (துருத்தி) to increase temperature. Charcoal was used as fuel. The process produced iron, copper, and bronze items for tools and weapons.",
    answerTamil: "உலைக்களம் என்பது உயர் வெப்பத்தைப் பயன்படுத்தி தாதுக்களிலிருந்து உலோகங்களை பிரித்தெடுக்கும் கட்டமைப்பு ஆகும். பண்டைய தமிழகத்தில் கோடுமணல், ஆதிச்சநல்லூர் மற்றும் மலைப்பகுதிகளில் இரும்பு உருக்கு சூளைகள் கண்டெடுக்கப்பட்டன. களிமண் சூளைகளில் துருத்தி (உலர்ந்த தோல் இதழ்) மூலம் வெப்பநிலை அதிகரிக்கப்பட்டது. கரிக்கட்டை எரிபொருளாக பயன்படுத்தப்பட்டது. இரும்பு, செம்பு, வெண்கல கருவிகள் மற்றும் ஆயுதங்கள் உற்பத்தி செய்யப்பட்டன.",
    keywordsEnglish: ["smelting furnace", "iron", "Kodumanal", "bellows", "charcoal", "ore"],
    keywordsTamil: ["உலைக்களம்", "இரும்பு", "கோடுமணல்", "துருத்தி", "கரிக்கட்டை", "தாது"],
  },
  {
    ...
    answerEnglish: "Sangam literature uses metaphorical references to iron: iron ore-bearing hills are described as producing iron 'crops' (இரும்புப் பயிர்). Akananuru and Purananuru describe iron smiths forging weapons at night with glowing furnaces. Patinappalai mentions iron merchants in the market. Terms like 'Irumbu' (இரும்பு) appear frequently, indicating the centrality of iron in the Sangam economy and warfare.",
    answerTamil: "சங்க இலக்கியங்கள் இரும்பை உருவகமான குறிப்புகளுடன் விவரிக்கின்றன. இரும்பு தாது கொண்ட மலைகள் இரும்பு 'பயிர்' விளைவிப்பதாக விவரிக்கப்படுகின்றன. அகநானூறும் புறநானூறும் இரவில் இரும்பு கொல்லர்கள் ஆயுதங்கள் இயற்றும் காட்சிகளை விவரிக்கின்றன. பட்டினப்பாலை சந்தையில் இரும்பு வணிகர்களை குறிப்பிடுகிறது. 'இரும்பு' என்ற சொல் அடிக்கடி தோன்றி சங்க கால பொருளாதாரத்திலும் போரிலும் இரும்பின் முக்கியத்துவத்தை காட்டுகிறது.",
    keywordsEnglish: ["iron", "Sangam", "Akananuru", "blacksmith", "Irumbu", "ore"],
    keywordsTamil: ["இரும்பு", "சங்க காலம்", "அகநானூறு", "கொல்லர்", "இரும்பு தாது"],
  },
  {
    unit: "Unit III", qNo: 7, marks: 2,
    questionEnglish: "Write a brief note about ancient coins.",
    questionTamil: "நாணயங்கள் குறிப்பு எழுக.",
    answerEnglish: "Ancient Tamil coins (நாணயங்கள்) were primarily made of copper, silver, and gold. They bore emblems of ruling dynasties: fish (Pandya), tiger (Chola), bow (Chera). Punch-marked coins were found at sites like Uraiyur and Karur. Roman coins found in Tamil Nadu attest to international trade. Coins helped move from barter to a monetary economy in Sangam times.",
    answerTamil: "பண்டைய தமிழ் நாணயங்கள் முக்கியமாக செம்பு, வெள்ளி மற்றும் தங்கத்தால் ஆனவை. இவற்றில் ஆட்சிகளின் சின்னங்கள் இருந்தன: மீன் (பாண்டியர்), புலி (சோழர்), வில் (சேரர்). உறையூர் மற்றும் கரூர் போன்ற இடங்களில் குத்துமுத்திரை நாணயங்கள் கண்டெடுக்கப்பட்டன. தமிழகத்தில் கண்டெடுக்கப்பட்ட ரோமன் நாணயங்கள் சர்வதேச வணிகத்தை உறுதிப்படுத்துகின்றன. நாணயங்கள் சங்க காலத்தில் பண்டமாற்றிலிருந்து பண வணிகத்திற்கு மாற உதவின.",
    keywordsEnglish: ["coins", "copper", "silver", "fish symbol", "Pandya", "Chola", "Roman coins"],
    keywordsTamil: ["நாணயங்கள்", "செம்பு", "வெள்ளி", "மீன் சின்னம்", "பாண்டியர்", "ரோமன் நாணயம்"],
  },
  {
    ...
    answerEnglish: "The nine Navaratnas (நவரத்தினங்கள்) are: (1) Diamond (வைரம்), (2) Ruby (மாணிக்கம்), (3) Emerald (மரகதம்), (4) Pearl (முத்து), (5) Coral (பவளம்), (6) Sapphire (நீலம்), (7) Cat's Eye (வைடூரியம்), (8) Hessonite Garnet (கோமேதகம்), (9) Yellow Sapphire (புஷ்பராகம்). These nine gems are associated with nine planets in Hindu astrology.",
    answerTamil: "நவரத்தினங்கள்: (1) வைரம் (Diamond), (2) மாணிக்கம் (Ruby), (3) மரகதம் (Emerald), (4) முத்து (Pearl), (5) பவளம் (Coral), (6) நீலம் (Sapphire), (7) வைடூரியம் (Cat's Eye), (8) கோமேதகம் (Hessonite Garnet), (9) புஷ்பராகம் (Yellow Sapphire). இந்த ஒன்பது இரத்தினங்கள் இந்து ஜோதிடத்தில் ஒன்பது கிரகங்களுடன் தொடர்புடையவை.",
    keywordsEnglish: ["diamond", "ruby", "emerald", "pearl", "coral", "sapphire", "Navaratna"],
    keywordsTamil: ["வைரம்", "மாணிக்கம்", "மரகதம்", "முத்து", "பவளம்", "நீலம்", "நவரத்தினம்"],
  },
  {
    unit: "Unit III", qNo: 9, marks: 2,
    questionEnglish: "Who are the Kammiyar?",
    questionTamil: "கம்மியர் என்பவர் யார்?",
    answerEnglish: "Kammiyar (கம்மியர்) are an ancient Tamil artisan community specializing in metalwork, particularly blacksmithing and gold/silversmithing. They are one of the Panchalas (five artisan castes) in Tamil tradition. They forged tools, weapons, agricultural implements, and ornaments. Their craftsmanship was vital to the economy, agriculture, and warfare of ancient Tamil society.",
    answerTamil: "கம்மியர் என்பவர் உலோக வேலைகளில், குறிப்பாக இரும்பு கொல்லர் மற்றும் தங்க/வெள்ளி ஆபரண தொழிலில் நிபுணத்துவம் கொண்ட பண்டைய தமிழ் கைவினை சமூகம் ஆவர். இவர்கள் தமிழ் மரபில் ஐந்து கைவினை சாதிகளில் (பஞ்சாலர்) ஒன்றாவர். கருவிகள், ஆயுதங்கள், வேளாண்மை சாதனங்கள் மற்றும் அணிகலன்கள் உருவாக்கினர்.",
    keywordsEnglish: ["Kammiyar", "metalwork", "blacksmith", "Panchalas", "tools", "weapons"],
    keywordsTamil: ["கம்மியர்", "உலோக வேலை", "கொல்லர்", "பஞ்சாலர்", "கருவிகள்", "ஆயுதங்கள்"],
  },
  {
    unit: "Unit III", qNo: 10, marks: 2,
    questionEnglish: "Who are the Kuyinar?",
    questionTamil: "குயிஞர் என்பவர் யார்?",
    answerEnglish: "Kuyinar (குயிஞர்) are an ancient Tamil artisan community of potters who specialize in making clay vessels and pottery. They are also part of the Panchalas (five artisan castes). They used the potter's wheel (குயவர் சக்கரம்) to create everyday utensils, storage pots, ritual vessels, and terracotta figurines. Their craft was essential to daily life, religion, and trade in ancient Tamil society.",
    answerTamil: "குயிஞர் என்பவர் களிமண் பாத்திரங்கள் மற்றும் மட்கலை தயாரிப்பில் நிபுணத்துவம் கொண்ட பண்டைய தமிழ் குயவர் சமூகம் ஆவர். இவர்களும் பஞ்சாலர்களில் ஒருவர். குயவர் சக்கரம் பயன்படுத்தி அன்றாட பாத்திரங்கள், சேமிப்பு குடங்கள், சடங்கு பாத்திரங்கள் மற்றும் மண் சிலைகள் உருவாக்கினர்.",
    keywordsEnglish: ["Kuyinar", "potters", "Panchalas", "potter's wheel", "clay vessels", "terracotta"],
    keywordsTamil: ["குயிஞர்", "குயவர்", "பஞ்சாலர்", "குயவர் சக்கரம்", "மட்கலை"],
  },
  {
    unit: "Unit III", qNo: 11, marks: 2,
    questionEnglish: "Name the different shapes of beads.",
    questionTamil: "மணிகளின் வடிவங்களைக்கூறுக.",
    answerEnglish: "Ancient Tamil beads came in various shapes: (1) Cylindrical (உருளை வடிவம்); (2) Spherical/Round (உருண்டை வடிவம்); (3) Disc-shaped (தட்டை வடிவம்); (4) Barrel-shaped (பீப்பாய் வடிவம்); (5) Bicone/Double-cone (இரட்டை கூம்பு); (6) Faceted/Multi-sided; (7) Elongated/Long tube shape. These shapes are found in archaeological sites like Kodumanal.",
    answerTamil: "பண்டைய தமிழ் மணிகள் பல வடிவங்களில் கிடைக்கின்றன: (1) உருளை வடிவம் (Cylindrical); (2) உருண்டை வடிவம் (Spherical); (3) தட்டை வடிவம் (Disc); (4) பீப்பாய் வடிவம் (Barrel); (5) இரட்டை கூம்பு (Bicone); (6) பல முகங்கள் கொண்ட; (7) நீண்ட குழாய் வடிவம். இவை கோடுமணல் போன்ற தொல்லியல் களங்களில் கண்டெடுக்கப்பட்டன.",
    keywordsEnglish: ["cylindrical", "spherical", "disc", "barrel", "bicone", "beads", "Kodumanal"],
    keywordsTamil: ["உருளை வடிவம்", "உருண்டை", "தட்டை", "பீப்பாய்", "இரட்டை கூம்பு", "மணிகள்"],
  },
  {
    ...
    answerEnglish: "Colored glass beads (வண்ணக்கண் / வண்ண மணிகள்) were highly prized ornamental items in ancient Tamil Nadu. Found extensively at Arikamedu (Puducherry) and Kodumanal, they were made of silica-based glass colored with metallic oxides. Colors included blue, green, amber, and red. They were used in necklaces, earrings, and traded internationally with Rome and Southeast Asia.",
    answerTamil: "வண்ண கண்ணாடி மணிகள் பண்டைய தமிழகத்தில் மிகவும் விலையுயர்ந்த அலங்கார பொருட்களாக இருந்தன. அரிக்கமேடு (புதுச்சேரி) மற்றும் கோடுமணலில் பரவலாக கண்டெடுக்கப்பட்டன. உலோக ஆக்சைடுகளால் வண்ணமிடப்பட்ட சிலிக்கா அடிப்படையிலான கண்ணாடியால் செய்யப்பட்டன. நீலம், பச்சை, செம்பழுப்பு மற்றும் சிவப்பு வண்ணங்களில் கிடைத்தன. முத்து மாலைகள், காதணிகளில் பயன்படுத்தப்பட்டு ரோம் மற்றும் தென்கிழக்கு ஆசியாவுடன் வணிகம் செய்யப்பட்டன.",
    keywordsEnglish: ["glass beads", "Arikamedu", "Kodumanal", "silica", "trade", "ornament"],
    keywordsTamil: ["கண்ணாடி மணிகள்", "அரிக்கமேடு", "கோடுமணல்", "சிலிக்கா", "வணிகம்", "அலங்காரம்"],
  },
  {
    ...
    answerEnglish: "Ancient Tamil beads are found in approximately seven major shapes: (1) Cylindrical (உருளை), (2) Spherical/Round (உருண்டை), (3) Disc/Flat (தட்டை), (4) Barrel (பீப்பாய் வடிவம்), (5) Bicone / Double cone (இரட்டை கூம்பு), (6) Faceted/Multi-faced (பல முகங்கள்), and (7) Long tube/Elongated (நீண்ட குழாய்). These shapes have been identified from excavations at Kodumanal, Arikamedu, and other Iron Age and Sangam-period sites in Tamil Nadu.",
    answerTamil: "பண்டைய தமிழ் மணிகள் சுமார் ஏழு முக்கிய வடிவங்களில் கண்டெடுக்கப்படுகின்றன: (1) உருளை வடிவம் (Cylindrical), (2) உருண்டை வடிவம் (Spherical), (3) தட்டை வடிவம் (Disc), (4) பீப்பாய் வடிவம் (Barrel), (5) இரட்டை கூம்பு (Bicone), (6) பல முகங்கள் (Faceted), (7) நீண்ட குழாய் (Elongated tube). இந்த வடிவங்கள் கோடுமணல், அரிக்கமேடு மற்றும் தமிழகத்தில் உள்ள பிற இரும்பு கால மற்றும் சங்க கால தளங்களில் கண்டெடுக்கப்பட்டுள்ளன.",
    keywordsEnglish: ["cylindrical", "spherical", "disc", "barrel", "bicone", "faceted", "elongated", "beads", "seven shapes"],
    keywordsTamil: ["உருளை", "உருண்டை", "தட்டை", "பீப்பாய்", "இரட்டை கூம்பு", "பல முகங்கள்", "ஏழு வடிவங்கள்"],
  },

  {
    ...
    answerEnglish: "Silappathikaram, particularly the Urukan Kādai chapter (ஊர்காண் காதை), mentions several types of precious beads and gems worn by women as ornaments: (1) Muktha (முத்து) – pearl beads; (2) Manikam (மாணிக்கம்) – ruby; (3) Marakadham (மரகதம்) – emerald; (4) Vairam (வைரம்) – diamond; (5) Pavalam (பவளம்) – coral; (6) Neelam (நீலம்) – sapphire; (7) Gomethagam (கோமேதகம்) – hessonite/carnelian. The epic vividly describes how these jewels adorned the women of the ancient Tamil port city.",
    answerTamil: "சிலப்பதிகாரத்தில், குறிப்பாக ஊர்காண் காதை அத்தியாயத்தில், பெண்கள் அணிந்துகொண்ட பல வகையான விலைமதிப்பற்ற மணிகள் மற்றும் இரத்தினங்கள் குறிப்பிடப்படுகின்றன: (1) முத்து, (2) மாணிக்கம் (ரூபி), (3) மரகதம் (மரகதக் கல்), (4) வைரம், (5) பவளம், (6) நீலம் (நீல நிறக் கல்), (7) கோமேதகம். இந்த காவியம் பண்டைய தமிழ் துறைமுக நகரத்தின் பெண்கள் இந்த இரத்தினங்களால் அலங்கரிக்கப்பட்டதை உவமிக்கிறது.",
    keywordsEnglish: ["Silappathikaram", "Urukan Kadai", "pearl", "ruby", "emerald", "diamond", "coral", "sapphire", "gems"],
    keywordsTamil: ["சிலப்பதிகாரம்", "ஊர்காண் காதை", "முத்து", "மாணிக்கம்", "மரகதம்", "வைரம்", "பவளம்", "நீலம்"],
  },

  {
    ...
    answerEnglish: "In ancient Tamil society, beads (made from carnelian, glass, gold, crystal, terracotta, and shell) were used to make various ornamental objects: (1) Necklaces (மாலைகள் / கழுத்தணி) – multi-strand and single-strand; (2) Earrings (காதணி / குண்டலம்); (3) Bracelets and bangles (வளையல்); (4) Anklets (சிலம்பு / கொலுசு); (5) Hair ornaments (சூடகம்); (6) Waist belt decorations (இடையணி); (7) Decorative items for ritual objects and deity images. These bead ornaments are documented in Sangam literature and recovered from Iron Age excavations.",
    answerTamil: "பண்டைய தமிழ் சமூகத்தில், மணிகள் (கோமேதகம், கண்ணாடி, தங்கம், பளிங்கு, மண், சிப்பி ஆகியவற்றால் ஆனவை) பல்வேறு அலங்கார பொருட்களை தயாரிக்கப் பயன்பட்டன: (1) மாலைகள் / கழுத்தணி – பல திரி மற்றும் ஒற்றை திரி; (2) காதணி / குண்டலம்; (3) வளையல்கள்; (4) சிலம்பு / கொலுசு; (5) தலை அணிகலன்கள் (சூடகம்); (6) இடையணி அலங்காரங்கள்; (7) சடங்கு பொருட்கள் மற்றும் தெய்வ சிலைகளுக்கான அலங்கார பொருட்கள். சங்க இலக்கியம் மற்றும் இரும்பு கால அகழாய்வுகள் இந்த மணி அணிகலன்களை ஆவணப்படுத்தியுள்ளன.",
    keywordsEnglish: ["necklaces", "earrings", "bracelets", "anklets", "hair ornaments", "beads", "carnelian", "ornaments"],
    keywordsTamil: ["மாலைகள்", "காதணி", "வளையல்", "சிலம்பு", "சூடகம்", "மணிகள்", "கோமேதகம்", "அணிகலன்கள்"],
  },
  {
...
1. கட்டுமரம்:
• மூன்று முதல் ஐந்து கொட்டை கட்டுடன் கோஃப் தண்ணீரில் பயன்படுத்தப்படும்
...
முக்கிய சொற்கள்: ஊர்காண் காதை, சிலப்பதிகாரம், முத்து, மாணிக்கம், கோமேதகம், சிலம்பு, புகார், கோவலன், கண்ணகி`,
  ...
  // ─── UNIT IV ───
  {
    ...
    answerEnglish: "Kallanai (கல்லணை), also known as the Grand Anicut, is one of the oldest water regulation structures in the world, built across the Kaveri River in Thanjavur district. It was constructed by Chola king Karikalan around 2nd century CE. Made of rough-cut stone without mortar, it diverts Kaveri waters into canals for irrigation. It is still functional today after over 2000 years.",
    answerTamil: "கல்லணை, கிராண்ட் ஆனிகட் என்றும் அழைக்கப்படும், உலகின் பழமையான நீர் ஒழுங்குமுறை கட்டமைப்புகளில் ஒன்றாகும். இது தஞ்சாவூர் மாவட்டத்தில் காவிரி நதியில் சோழ அரசன் கரிகாலனால் கி.பி. 2ஆம் நூற்றாண்டில் கட்டப்பட்டது. சாந்து இல்லாமல் வெட்டப்பட்ட கற்களால் ஆனது, காவிரி நீரை பாசன கால்வாய்களுக்கு திருப்பிவிடுகிறது. 2000 ஆண்டுகளுக்கும் மேலாக இன்றும் செயல்படுகிறது.",
    keywordsEnglish: ["Kallanai", "Grand Anicut", "Karikalan", "Chola", "Kaveri", "irrigation", "2000 years"],
    keywordsTamil: ["கல்லணை", "கரிகாலன்", "சோழர்", "காவிரி", "பாசனம்", "2000 ஆண்டுகள்"],
  },
  {
    unit: "Unit IV", qNo: 2, marks: 2,
    questionEnglish: "Who were the Neer Vettiyar?",
    questionTamil: "நீர் வெட்டியார் என்பவர் யார்?",
    answerEnglish: "Neer Vettiyar (நீர் வெட்டியார்) were water distributors or canal officers in ancient Tamil Nadu responsible for regulating and distributing irrigation water fairly among farmers. They ensured equitable water sharing from tanks and canals, maintained water channels, and resolved water-related disputes. They were an important part of the ancient Tamil administrative water management system.",
    answerTamil: "நீர் வெட்டியார் என்பவர் பண்டைய தமிழகத்தில் விவசாயிகளுக்கு நீர்ப்பாசன நீரை நியாயமாக சீராக்கி விநியோகிக்கும் பொறுப்பில் இருந்த நீர் விநியோகிகள் அல்லது கால்வாய் அதிகாரிகள் ஆவர். குளங்கள் மற்றும் கால்வாய்களிலிருந்து சம நீர் பங்கீட்டை உறுதி செய்தனர், நீர் வழிகளை பராமரித்தனர், நீர் தொடர்பான தகராறுகளை தீர்த்தனர்.",
    keywordsEnglish: ["Neer Vettiyar", "water distributor", "irrigation", "canal officer", "water management"],
    keywordsTamil: ["நீர் வெட்டியார்", "நீர் விநியோகி", "பாசனம்", "கால்வாய் அதிகாரி", "நீர் மேலாண்மை"],
  },
  {
    unit: "Unit IV", qNo: 3, marks: 2,
    questionEnglish: "Write a note about Kumizhi Thoombu.",
    questionTamil: "குமிழித்தூம்பு குறிப்பு எழுக.",
    answerEnglish: "Kumizhi Thoombu (குமிழித்தூம்பு) is an ancient Tamil water-lifting device (similar to a sluice or water lift) used to raise water from a lower level to irrigate elevated fields. It operated using counterweights or manual labor. This traditional irrigation technology is mentioned in Sangam literature and shows the advanced water management knowledge of ancient Tamils.",
    answerTamil: "குமிழித்தூம்பு என்பது பண்டைய தமிழர்கள் பயன்படுத்திய நீர் உயர்த்தும் கருவி. கீழ் தளத்திலிருந்து நீரை உயர்த்தி, உயர்ந்த வயல்களுக்கு பாசனம் செய்யப் பயன்பட்டது. எதிர் எடைகள் அல்லது கை உழைப்பால் இயங்கியது. இந்த பாரம்பரிய பாசன தொழில்நுட்பம் சங்க இலக்கியத்தில் குறிப்பிடப்படுகிறது, பண்டைய தமிழரின் நீர் மேலாண்மை அறிவை வெளிப்படுத்துகிறது.",
    keywordsEnglish: ["Kumizhi Thoombu", "water lifting", "irrigation", "Sangam", "traditional technology"],
    keywordsTamil: ["குமிழித்தூம்பு", "நீர் உயர்த்தும் கருவி", "பாசனம்", "சங்க காலம்"],
  },
  {
    unit: "Unit IV", qNo: 4, marks: 2,
    questionEnglish: "Who constructed the Thiraiyan Eri?",
    questionTamil: "திரையன் ஏரியை அமைத்தவர் யார்?",
    answerEnglish: "Thiraiyan Eri (திரையன் ஏரி) is an ancient tank (ஏரி/lake) in Tamil Nadu. It was constructed by the local chieftain or king named Thiraiyan. Sangam literature references tank construction by local rulers as an act of benevolence and service to the farming community. Such tanks were vital for storing rainwater and ensuring year-round irrigation for agricultural lands.",
    answerTamil: "திரையன் ஏரி என்பது தமிழகத்தில் உள்ள ஒரு பண்டைய ஏரி. இது திரையன் என்ற உள்ளூர் தலைவர் அல்லது அரசரால் கட்டப்பட்டது. சங்க இலக்கியம் உள்ளூர் ஆட்சியாளர்கள் விவசாய சமூகத்திற்கு சேவையாக ஏரிகளை கட்டியதை குறிப்பிடுகிறது. இந்த ஏரிகள் மழை நீரை சேமித்து ஆண்டு முழுவதும் பாசனம் உறுதி செய்ய இன்றியமையாதவை.",
    keywordsEnglish: ["Thiraiyan", "Eri", "tank", "Sangam", "irrigation", "chieftain"],
    keywordsTamil: ["திரையன்", "ஏரி", "குளம்", "சங்க காலம்", "பாசனம்", "தலைவர்"],
  },
  {
    ...
    answerEnglish: "The Seven Committees (ஏழு வாரியங்கள்) were administrative bodies established by the Chola kings, particularly during the medieval period. Inscriptions from Uttaramerur (Kanchipuram district) mention king Parantaka Chola I establishing these committees for local governance. These committees managed village affairs, tanks, garden lands, and welfare activities.",
    answerTamil: "ஏழு வாரியங்கள் என்பது சோழ அரசர்களால், குறிப்பாக இடைக்கால காலகட்டத்தில் நிறுவப்பட்ட நிர்வாக அமைப்புகள். உத்தரமேரூர் கல்வெட்டுகள் (காஞ்சிபுரம் மாவட்டம்) பராந்தக சோழன் I நிறுவிய இந்த குழுக்களை குறிப்பிடுகின்றன. இந்த குழுக்கள் கிராம விவகாரங்கள், குளங்கள், தோட்ட நிலங்கள் மற்றும் நலன்புரி செயல்பாடுகளை நிர்வகித்தன.",
    keywordsEnglish: ["Seven Committees", "Variyam", "Chola", "Uttaramerur", "Parantaka", "local governance"],
    keywordsTamil: ["ஏழு வாரியங்கள்", "சோழர்", "உத்தரமேரூர்", "பராந்தக சோழன்", "நிர்வாகம்"],
  },
  {
    unit: "Unit IV", qNo: 6, marks: 2,
    questionEnglish: "Who were the Neeranikkararkal?",
    questionTamil: "நீரணிக்காரர்கள் என்பவர் யார்?",
    answerEnglish: "Neeranikkararkal (நீரணிக்காரர்கள்) were traditional water managers or water supervisors in ancient Tamil Nadu who oversee the proper flow and distribution of water in irrigation channels and tanks. They served as community water administrators ensuring all farmers received their allocated water share, especially during tank-based irrigation in delta regions.",
    answerTamil: "நீரணிக்காரர்கள் என்பவர் பண்டைய தமிழகத்தில் பாசன கால்வாய்கள் மற்றும் குளங்களில் நீரின் சரியான ஓட்டம் மற்றும் விநியோகத்தை கண்காணிக்கும் பாரம்பரிய நீர் மேலாளர்கள் ஆவர். இவர்கள் சமூக நீர் நிர்வாகிகளாக செயல்பட்டு, குறிப்பாக டெல்டா பகுதிகளில் குளங்கள் அடிப்படையிலான பாசனத்தில் அனைத்து விவசாயிகளும் தங்களுக்கு ஒதுக்கப்பட்ட நீர் பங்கை பெற உறுதி செய்தனர்.",
    keywordsEnglish: ["Neeranikkararkal", "water manager", "irrigation", "tank", "water distribution"],
    keywordsTamil: ["நீரணிக்காரர்கள்", "நீர் மேலாளர்", "பாசனம்", "குளம்", "நீர் விநியோகம்"],
  },
  {
    unit: "Unit IV", qNo: 7, marks: 2,
    questionEnglish: "Write a note about Madai (sluice gate).",
    questionTamil: "மடை குறிப்பு எழுக.",
    answerEnglish: "Madai (மடை) refers to the sluice gate or control structure in ancient Tamil irrigation tanks and reservoirs. It is the opening or valve mechanism that controls the flow of water from a tank into the irrigation channels below. Madai construction was a critical engineering component; its proper maintenance ensured controlled water release to prevent flooding while sustaining agricultural supply.",
    answerTamil: "மடை என்பது பண்டைய தமிழ் பாசன குளங்கள் மற்றும் நீர்த்தேக்கங்களில் உள்ள தூம்பு வாயில் அல்லது கட்டுப்பாட்டு கட்டமைப்பு ஆகும். இது குளத்திலிருந்து பாசன கால்வாய்களுக்கு நீரின் ஓட்டத்தை கட்டுப்படுத்தும் திறப்பு அல்லது வால்வு அமைப்பு. மடை கட்டுமானம் முக்கிய பொறியியல் கூறு; சரியான பராமரிப்பு வெள்ளத்தை தடுத்து வேளாண்மை விநியோகம் நிலைத்திருக்க உதவியது.",
    keywordsEnglish: ["Madai", "sluice gate", "tank", "irrigation", "water control"],
    keywordsTamil: ["மடை", "தூம்பு வாயில்", "குளம்", "பாசனம்", "நீர் கட்டுப்பாடு"],
  },
  {
    ...
    answerEnglish: "Ancient Tamils relied on diverse water resources: (1) Eri (ஏரி) – tanks/ponds for rain-fed storage; (2) Kulam (குளம்) – smaller community ponds; (3) River (ஆறு) – Kaveri, Vaigai, Tamirabarani; (4) Wells (கிணறு) – for drinking and small-scale irrigation; (5) Canals (கால்வாய்) – for distributing river/tank water. Water management was central to Sangam-era governance.",
    answerTamil: "பண்டைய தமிழர்கள் பல்வகை நீர் ஆதாரங்களை நம்பினர்: (1) ஏரி – மழை நீர் சேமிப்பு; (2) குளம் – சிறிய சமூக தடாகம்; (3) ஆறு – காவிரி, வைகை, தாமிரபரணி; (4) கிணறு – குடிநீர் மற்றும் சிறு பாசனம்; (5) கால்வாய் – ஆறு/குளம் நீரை விநியோகிக்க. நீர் மேலாண்மை சங்க கால நிர்வாகத்தின் மையமாக இருந்தது.",
    keywordsEnglish: ["Eri", "Kulam", "wells", "canals", "Kaveri", "water management", "Sangam"],
    keywordsTamil: ["ஏரி", "குளம்", "கிணறு", "கால்வாய்", "காவிரி", "நீர் மேலாண்மை"],
  },
  {
    unit: "Unit IV", qNo: 9, marks: 2,
    questionEnglish: "Write a note about Muraipanai.",
    questionTamil: "முறை பாகை குறிப்பு எழுக.",
    answerEnglish: "Muraipanai (முறைப்பாகை / முறை பாகை) refers to the traditional rotational water sharing system practiced in ancient Tamil irrigation management. Under this system, each farmer was allocated a fixed rotation turn to receive water from the shared tank or canal. This equitable rotation prevented conflicts and ensured all landholders received adequate irrigation for their crops.",
    answerTamil: "முறைப்பாகை என்பது பண்டைய தமிழ் நீர்ப்பாசன மேலாண்மையில் கடைப்பிடிக்கப்பட்ட பாரம்பரிய சுழல் நீர் பகிர்வு முறை ஆகும். இந்த முறையின் கீழ் ஒவ்வொரு விவசாயியும் பகிர்ந்த குளம் அல்லது கால்வாயிலிருந்து நீர் பெற நிர்ணயிக்கப்பட்ட சுழல் முறை வழங்கப்பட்டது. இந்த நியாயமான சுழல் தகராறுகளை தடுத்து நிலமுடைய அனைவரும் போதுமான பாசனம் பெற உறுதி செய்தது.",
    keywordsEnglish: ["Muraipanai", "rotational water sharing", "irrigation", "equitable", "tank"],
    keywordsTamil: ["முறைப்பாகை", "சுழல் நீர் பகிர்வு", "பாசனம்", "நியாயமான பகிர்வு"],
  },
  {
    ...
    answerEnglish: "Tamil literature mentions various water bodies: (1) Eri (ஏரி) – tanks; (2) Kulam (குளம்) – small ponds; (3) Vaav (வாவி) – larger reservoirs; (4) Kaveri, Vaigai, Tamiraparani, Palar – major rivers; (5) Kadalul (கடல்) – sea; (6) Keni (கேணி) – step wells; (7) Aaru (ஆறு) – rivers generally. Each body is associated with specific landscapes (tinai) in Sangam poetry.",
    answerTamil: "தமிழ் இலக்கியங்கள் பல நீர்நிலைகளை குறிப்பிடுகின்றன: (1) ஏரி – குளங்கள்; (2) குளம் – சிறிய தடாகங்கள்; (3) வாவி – பெரிய நீர்த்தேக்கங்கள்; (4) காவிரி, வைகை, தாமிரபரணி, பாலாறு – முக்கிய நதிகள்; (5) கடல்; (6) கேணி – படிக்கட்டு கிணறுகள்; (7) ஆறு – பொதுவாக நதிகள். ஒவ்வொரு நீர்நிலையும் சங்க கவிதையில் குறிப்பிட்ட திணைகளுடன் தொடர்புடையது.",
    keywordsEnglish: ["Eri", "Kulam", "Vaav", "Kaveri", "Keni", "Sangam", "Tinai"],
  ...
  },
  {
    ...
    answerEnglish: "Pastoral occupations (மேய்ச்சல் தொழில்) in ancient Tamil society were primarily associated with the Mullai (முல்லை) landscape (forest and pastoral regions). Communities like the Idaiyar (ஆயர்) herded cattle, sheep, and goats. Milk, butter, and ghee were important products. Sangam literature (especially Kurincippattu and Akananuru) extensively describes pastoral life, cattle raids (வெட்சி), and cattle fairs.",
    answerTamil: "பண்டைய தமிழ் சமூகத்தில் மேய்ச்சல் தொழில்கள் முக்கியமாக முல்லை திணை (காடு மற்றும் மேய்ச்சல் பகுதிகள்) உடன் தொடர்புடையவை. ஆயர் போன்ற சமூகங்கள் மாடு, ஆடு, செம்மறியாடுகளை மேய்த்தனர். பால், வெண்ணெய், நெய் முக்கிய விளைபொருட்கள். சங்க இலக்கியம் (குறிஞ்சிப்பாட்டு, அகநானூறு) மேய்ச்சல் வாழ்க்கை, கால்நடை கொள்ளை (வெட்சி) மற்றும் கால்நடை சந்தைகளை விரிவாக விவரிக்கிறது.",
    keywordsEnglish: ["pastoral", "Mullai", "Idaiyar", "cattle", "Sangam", "Vetchi"],
    keywordsTamil: ["மேய்ச்சல்", "முல்லை திணை", "ஆயர்", "கால்நடை", "வெட்சி"],
  },
  {
    ...
    answerEnglish: "Water sources for cattle in ancient Tamil Nadu included: (1) Rivers and streams (ஆறு, கால்வாய்); (2) Natural ponds and tanks (குளம், ஏரி); (3) Wells dug in forests and grazing lands; (4) Seasonal water bodies like marshes and waterholes. Sangam literature describes cattle grazing near river banks and forest water sources in the Mullai landscape regions.",
    answerTamil: "பண்டைய தமிழகத்தில் கால்நடைகளுக்கான நீர் ஆதாரங்கள்: (1) ஆறுகள் மற்றும் நீரோடைகள்; (2) இயற்கை குளங்கள் மற்றும் ஏரிகள்; (3) காடுகள் மற்றும் மேய்ச்சல் நிலங்களில் தோண்டிய கிணறுகள்; (4) சதுப்பு நிலங்கள் மற்றும் தண்ணீர் குழிகள் போன்ற பருவகால நீர்நிலைகள். சங்க இலக்கியம் முல்லை பகுதி ஆறு கரைகளிலும் காட்டு நீர் ஆதாரங்களிலும் கால்நடைகள் மேய்வதை விவரிக்கிறது.",
    keywordsEnglish: ["cattle", "rivers", "ponds", "wells", "Mullai", "grazing"],
    keywordsTamil: ["கால்நடை", "ஆறுகள்", "குளங்கள்", "கிணறுகள்", "முல்லை", "மேய்ச்சல்"],
  },
  {
    ...
    answerEnglish: "Vanpulam (வன்புலம்) refers to the dry, hard land regions (like Marudam/Palai) suitable for dry farming. Menpulam (மென்புலம்) refers to the soft, fertile, wet land suitable for paddy and irrigation-based agriculture (like Marudam fertile delta). This classification of land based on soil quality and water availability was fundamental to ancient Tamil agricultural planning and crop selection.",
    answerTamil: "வன்புலம் என்பது வறண்ட, கடினமான நில பகுதிகளை (மருதம்/பாலை போல்) குறிக்கிறது – வறட்சி விவசாயத்திற்கு ஏற்றது. மென்புலம் என்பது மென்மையான, வளமான, ஈரமான நிலத்தை குறிக்கிறது – நெல் மற்றும் பாசன அடிப்படையிலான விவசாயத்திற்கு ஏற்றது (மருதம் வளமான டெல்டா போல்). நில தரம் மற்றும் நீர் கிடைக்கும் தன்மை அடிப்படையிலான இந்த நில வகைப்பாடு பண்டைய தமிழ் வேளாண்மை திட்டமிடல் மற்றும் பயிர் தேர்வுக்கு அடிப்படையாக இருந்தது.",
    keywordsEnglish: ["Vanpulam", "Menpulam", "dry land", "fertile land", "agriculture", "Marudam"],
    keywordsTamil: ["வன்புலம்", "மென்புலம்", "வறண்ட நிலம்", "வளமான நிலம்", "வேளாண்மை", "மருதம்"],
  },
  {
    ...
    answerEnglish: "Sea birds mentioned in Sangam Tamil literature include: (1) Kadalai (கடலை) – sea gull; (2) Naarai (நாரை) – heron/crane; (3) Veli (வேலி) – a water bird; (4) Aalvai (ஆல்வாய்) – a coastal bird; (5) Kuruku (குருகு) – a type of crane. These birds are associated with the Neythal (coastal) tinai in Sangam poetry and symbolize the coastal landscape.",
    answerTamil: "சங்க தமிழ் இலக்கியங்களில் குறிப்பிடப்படும் கடல் வாழ் பறவைகள்: (1) கடலை – கடற்காக்கை; (2) நாரை – கொக்கு/நாரை; (3) வேலி – ஒரு நீர் பறவை; (4) ஆல்வாய் – ஒரு கடலோர பறவை; (5) குருகு – ஒரு வகை கொக்கு. இந்த பறவைகள் சங்க கவிதையில் நெய்தல் திணையுடன் தொடர்புடையவை, கடலோர நிலப்பரப்பை குறிக்கின்றன.",
    keywordsEnglish: ["Kadalai", "Naarai", "Kuruku", "Neythal", "coastal birds", "Sangam"],
    keywordsTamil: ["கடலை", "நாரை", "குருகு", "நெய்தல் திணை", "கடலோர பறவைகள்"],
  },
  {
    unit: "Unit IV", qNo: 15, marks: 2,
    questionEnglish: "Write a note about pearl diving.",
    questionTamil: "முத்துக்குளித்தல் குறிப்பு எழுக.",
    answerEnglish: "Pearl diving (முத்துக்குளித்தல்) was a traditional occupation of ancient Tamil coastal communities, especially the Parathavar. The Gulf of Mannar and Palk Strait were renowned pearl fishing zones. Divers held a stone tied to a rope to sink quickly, held their breath, collected oysters (முத்துச்சிப்பி), and surfaced. Sangam literature and later Madurai Kanji mention pearl trade as a significant economic activity.",
    answerTamil: "முத்துக்குளித்தல் என்பது பண்டைய தமிழ் கடலோர சமூகங்களின், குறிப்பாக பரதர்களின், பாரம்பரிய தொழிலாகும். மன்னார் வளைகுடா மற்றும் பாக் நீர்ச்சன்னல் பிரபல முத்து மீன்பிடி மண்டலங்கள். மூழ்கிகள் கயிற்றில் கட்டிய கல் ஏந்தி விரைவாக ஆழத்தில் மூழ்கி, மூச்சை பிடித்துக்கொண்டு முத்துச்சிப்பிகளை சேகரித்து மேலே வந்தனர். சங்க இலக்கியம் மற்றும் மதுரைக்காஞ்சி முத்து வணிகத்தை முக்கிய பொருளாதார செயல்பாடாக குறிப்பிடுகின்றன.",
    keywordsEnglish: ["pearl diving", "Parathavar", "Gulf of Mannar", "oysters", "Sangam", "Madurai Kanji"],
    keywordsTamil: ["முத்துக்குளிப்பு", "பரதர்", "மன்னார் வளைகுடா", "முத்துச்சிப்பி", "மதுரைக்காஞ்சி"],
  },
  {
    ...
    answerEnglish: "Four benefits of ponds (குளம்/ஏரி): (1) Irrigation supply – provide water to surrounding agricultural fields throughout the year; (2) Groundwater recharge – water percolates and raises the local water table; (3) Flood control – absorb excess rainwater during monsoons; (4) Drinking water and livestock use – serve as community water source for humans and animals.",
    answerTamil: "குளங்களின் நான்கு வன்மைகள்: (1) பாசன விநியோகம் – சுற்றிலும் உள்ள வேளாண்மை நிலங்களுக்கு ஆண்டு முழுவதும் நீர் வழங்கும்; (2) நிலத்தடி நீர் நிரப்பல் – நீர் ஊடுருவி உள்ளூர் நீர்மட்டத்தை உயர்த்தும்; (3) வெள்ள கட்டுப்பாடு – பருவமழையில் அதிகப்படியான மழை நீரை உள்வாங்கும்; (4) குடிநீர் மற்றும் கால்நடை பயன்பாடு – மனிதர்களுக்கும் விலங்குகளுக்கும் சமூக நீர் ஆதாரமாக செயல்படும்.",
    keywordsEnglish: ["irrigation", "groundwater recharge", "flood control", "drinking water", "pond"],
    keywordsTamil: ["பாசனம்", "நிலத்தடி நீர்", "வெள்ள கட்டுப்பாடு", "குடிநீர்", "குளம்"],
  },
  {
    "unit": "Unit IV",
    "qNo": 17,
  ...
  // ─── UNIT V ───
  {
    ...
    answerEnglish: "Computational Tamil (கணித்தமிழ் / Kanithamizh) refers to the application of information technology and computer science to the Tamil language. It includes Tamil script encoding (Unicode), natural language processing (NLP) for Tamil, Tamil text-to-speech, speech recognition, machine translation, spell checkers, and Tamil software development. It aims to preserve and expand the use of Tamil in the digital world.",
    answerTamil: "கணித்தமிழ் என்பது தகவல் தொழில்நுட்பம் மற்றும் கணினி அறிவியலை தமிழ் மொழியில் பயன்படுத்துவது ஆகும். தமிழ் எழுத்து குறியாக்கம் (யுனிகோட்), தமிழ் இயற்கை மொழி செயலாக்கம் (NLP), தமிழ் உரை-பேச்சு, பேச்சு அங்கீகாரம், இயந்திர மொழிபெயர்ப்பு, எழுத்துப்பிழை திருத்திகள் மற்றும் தமிழ் மென்பொருள் உருவாக்கம் அடங்கும். டிஜிட்டல் உலகில் தமிழை பாதுகாத்து விரிவுபடுத்துவதை நோக்கமாக கொண்டது.",
    keywordsEnglish: ["Kanithamizh", "Unicode", "NLP", "Tamil software", "digital", "text-to-speech"],
    keywordsTamil: ["கணித்தமிழ்", "யுனிகோட்", "NLP", "தமிழ் மென்பொருள்", "டிஜிட்டல்"],
  },
  {
    ...
    answerEnglish: "The Tamil Virtual Academy (தமிழ் இணையக் கல்விக் கழகம் – TIVA) was established in 2001. It was set up by the Tamil Nadu Government to promote Tamil language education through the internet. It was formerly known as Tamil Internet Education (தமிழ் இணைய கல்வி). It provides online Tamil learning resources, e-books, dictionaries, and courses.",
    answerTamil: "தமிழ் இணையக் கல்விக் கழகம் (TIVA) 2001ஆம் ஆண்டில் தொடங்கப்பட்டது. இணையத்தின் வழியாக தமிழ் மொழி கல்வியை மேம்படுத்துவதற்காக தமிழ்நாடு அரசு இதை நிறுவியது. இது முன்பு 'தமிழ் இணைய கல்வி' என்று அழைக்கப்பட்டது. ஆன்லைன் தமிழ் கல்வி வளங்கள், மின்னூல்கள், அகராதிகள் மற்றும் படிப்புகளை வழங்குகிறது.",
    keywordsEnglish: ["Tamil Virtual Academy", "2001", "TIVA", "e-learning", "Tamil Nadu Government"],
    keywordsTamil: ["தமிழ் இணையக் கல்விக் கழகம்", "2001", "TIVA", "மின்கல்வி"],
  },
  {
    unit: "Unit V", qNo: 3, marks: 2,
    questionEnglish: "Name three e-learning systems.",
    questionTamil: "மின்னூல் அமைப்புகள் மூன்றினைக் கூறுக.",
    answerEnglish: "Three important e-learning systems are: (1) Tamil Virtual Academy (TIVA) – provides online Tamil language education; (2) SWAYAM (Study Webs of Active-Learning for Young Aspiring Minds) – Indian government's online education platform; (3) MOOC (Massive Open Online Courses) – platforms like Coursera and edX offering open online learning globally.",
    answerTamil: "மூன்று முக்கிய மின்கல்வி அமைப்புகள்: (1) தமிழ் இணையக் கல்விக் கழகம் (TIVA) – ஆன்லைன் தமிழ் மொழி கல்வி வழங்குகிறது; (2) SWAYAM – இந்திய அரசின் ஆன்லைன் கல்வி தளம்; (3) MOOC (பாரிய திறந்தநிலை ஆன்லைன் படிப்புகள்) – Coursera மற்றும் edX போன்ற தளங்கள் உலக அளவில் திறந்த ஆன்லைன் கல்வி வழங்குகின்றன.",
    keywordsEnglish: ["TIVA", "SWAYAM", "MOOC", "e-learning", "online education"],
    keywordsTamil: ["TIVA", "SWAYAM", "MOOC", "மின்கல்வி", "ஆன்லைன் கல்வி"],
  },
  {
    ...
    answerEnglish: "Tamil software is developed at: (1) Tamil Virtual Academy (TIVA), Chennai; (2) Central Institute of Indian Languages (CIIL), Mysore; (3) AU-KBC Research Centre, Anna University, Chennai; (4) Technology Development for Indian Languages (TDIL), Government of India; (5) C-DAC (Centre for Development of Advanced Computing), Pune.",
    answerTamil: "தமிழ் மென்பொருள் உருவாக்கும் நிறுவனங்கள்: (1) தமிழ் இணையக் கல்விக் கழகம் (TIVA), சென்னை; (2) மத்திய இந்திய மொழிகள் நிறுவனம் (CIIL), மைசூர்; (3) AU-KBC ஆராய்ச்சி மையம், அண்ணா பல்கலைக்கழகம், சென்னை; (4) இந்திய மொழிகளுக்கான தொழில்நுட்ப மேம்பாடு (TDIL), இந்திய அரசு; (5) C-DAC, புனே.",
    keywordsEnglish: ["TIVA", "CIIL", "AU-KBC", "TDIL", "C-DAC", "Tamil software"],
    keywordsTamil: ["TIVA", "CIIL", "AU-KBC", "TDIL", "C-DAC", "தமிழ் மென்பொருள்"],
  },
  {
    unit: "Unit V", qNo: 5, marks: 2,
    questionEnglish: "Write a note on digital libraries.",
    questionTamil: "மின் நூலகம் குறிப்பு எழுக.",
    answerEnglish: "A digital library (மின் நூலகம் / E-library) is a collection of digital objects – books, articles, audio, video – accessible via the internet. For Tamil: Tamil Digital Library (tamildigitallibrary.in) and Project Madurai digitize ancient Tamil texts. Benefits: 24/7 accessibility, easy search, no physical space needed, preservation of rare manuscripts.",
    answerTamil: "மின் நூலகம் என்பது இணையம் வழியாக அணுகக்கூடிய டிஜிட்டல் பொருட்களின் தொகுப்பு – புத்தகங்கள், கட்டுரைகள், ஒலி, காணொலி. தமிழுக்காக: தமிழ் டிஜிட்டல் நூலகம் (tamildigitallibrary.in) மற்றும் 'திட்டம் மதுரை' பண்டைய தமிழ் நூல்களை டிஜிட்டல் வடிவாக்குகின்றன. நன்மைகள்: 24/7 அணுகல், எளிய தேடல், இயற்பியல் இடம் தேவையில்லை, அரிய கையெழுத்துப் பிரதிகள் பாதுகாப்பு.",
    keywordsEnglish: ["digital library", "e-library", "Project Madurai", "Tamil texts", "24/7 access"],
  ...
  },
  {
    ...
    answerEnglish: "Online dictionaries (மின் அகராதி) provide instant word definitions, translations, and usage examples via the internet. Tamil online dictionaries include: (1) University of Madras Tamil Lexicon (online); (2) Maduram Online Dictionary; (3) Tamil Wiktionary; (4) Agaraadhi.org. These tools help students, researchers, and language learners access Tamil vocabulary anytime and anywhere.",
    answerTamil: "மின் அகராதிகள் இணையம் வழியாக உடனடி சொல் விளக்கங்கள், மொழிபெயர்ப்புகள் மற்றும் பயன்பாட்டு எடுத்துக்காட்டுகளை வழங்குகின்றன. தமிழ் ஆன்லைன் அகராதிகள்: (1) சென்னை பல்கலைக்கழக தமிழ் அகராதி (ஆன்லைன்); (2) மதுரம் மின் அகராதி; (3) தமிழ் விக்சனரி; (4) அகராதி.org. இந்த கருவிகள் மாணவர்கள், ஆராய்ச்சியாளர்கள் மற்றும் மொழி கற்பவர்கள் எங்கும் எப்போதும் தமிழ் சொல்வளஞ்சேரியை அணுக உதவுகின்றன.",
    keywordsEnglish: ["online dictionary", "Tamil Lexicon", "Maduram", "Tamil Wiktionary", "digital resources"],
  ...
  },
  {
    ...
    answerEnglish: "The Maduram (மதுரம்) Online Dictionary contains multiple components including Tamil-Tamil definitions, Tamil-English translations, Tamil-Sanskrit cross-references, proverbs (பழமொழி), idioms (சொற்றொடர்), and example sentences. It is one of the comprehensive multi-section Tamil digital dictionaries designed to serve both native speakers and language learners.",
    answerTamil: "மதுரம் மின் அகராதி தமிழ்-தமிழ் வரையறைகள், தமிழ்-ஆங்கிலம் மொழிபெயர்ப்புகள், தமிழ்-சமஸ்கிருதம் குறிப்புகள், பழமொழிகள், சொற்றொடர்கள் மற்றும் எடுத்துக்காட்டு வாக்கியங்கள் உள்ளிட்ட பல கூறுகளை கொண்டுள்ளது. இது தமிழ் பேசும் மக்கள் மற்றும் மொழி கற்பவர்கள் இருவருக்கும் பயன்படும் விரிவான பன்முகப் பிரிவு தமிழ் டிஜிட்டல் அகராதிகளில் ஒன்றாகும்.",
    keywordsEnglish: ["Maduram", "Tamil-Tamil", "Tamil-English", "proverbs", "idioms", "digital dictionary"],
    keywordsTamil: ["மதுரம்", "தமிழ்-தமிழ்", "தமிழ்-ஆங்கிலம்", "பழமொழி", "சொற்றொடர்"],
  },
  {
    unit: "Unit V", qNo: 8, marks: 2,
    questionEnglish: "Write a note on Tamil Wiktionary.",
    questionTamil: "தமிழ் விக்சனரி - குறிப்பு எழுக.",
    answerEnglish: "Tamil Wiktionary (தமிழ் விக்சனரி) is a free, collaboratively-edited multilingual dictionary project under Wikimedia Foundation. It provides Tamil word definitions, etymologies, translations into multiple languages, pronunciation guides, and usage examples. It is community-built and allows anyone to add or edit Tamil words. It helps preserve and document Tamil vocabulary in the digital age.",
    answerTamil: "தமிழ் விக்சனரி என்பது விக்கிமீடியா அறக்கட்டளையின் கீழ் இயங்கும் இலவச, கூட்டாக திருத்தப்படும் பன்மொழி அகராதி திட்டம். தமிழ் சொல் வரையறைகள், சொற்பிறப்பியல், பல மொழிகளில் மொழிபெயர்ப்புகள், உச்சரிப்பு வழிகாட்டிகள் மற்றும் பயன்பாட்டு எடுத்துக்காட்டுகளை வழங்குகிறது. சமூகத்தினரால் கட்டமைக்கப்பட்டது, யாரும் தமிழ் சொற்களை சேர்க்கவோ திருத்தவோ அனுமதிக்கிறது.",
    keywordsEnglish: ["Tamil Wiktionary", "Wikimedia", "free", "multilingual", "community-built"],
    keywordsTamil: ["தமிழ் விக்சனரி", "விக்கிமீடியா", "இலவச", "பன்மொழி", "சமூக உருவாக்கம்"],
  },
  {
    unit: "Unit V", qNo: 9, marks: 2,
    questionEnglish: "What is Sorkuvai Thittam?",
    questionTamil: "சொற்குவை திட்டம் என்றால் என்ன?",
    answerEnglish: "Sorkuvai Thittam (சொற்குவை திட்டம் – literally 'Word Treasury Project') is a digital corpus project aimed at collecting, organizing, and digitizing a large collection of Tamil words and texts. The project builds a comprehensive Tamil word database (corpus) for use in natural language processing, research, and lexicography. It supports Tamil computing and language technology development.",
    answerTamil: "சொற்குவை திட்டம் என்பது தமிழ் சொற்கள் மற்றும் நூல்களின் பெரிய தொகுப்பை சேகரித்து, ஒழுங்கமைத்து, டிஜிட்டல் வடிவாக்குவதை நோக்கமாக கொண்ட டிஜிட்டல் தொகுப்பு திட்டம். இந்த திட்டம் இயற்கை மொழி செயலாக்கம், ஆராய்ச்சி மற்றும் அகராதியியலுக்கு பயன்படுத்தக்கூடிய விரிவான தமிழ் சொல் தரவுத்தளத்தை (corpus) உருவாக்குகிறது.",
    keywordsEnglish: ["Sorkuvai Thittam", "word corpus", "Tamil NLP", "lexicography", "digital database"],
    keywordsTamil: ["சொற்குவை திட்டம்", "சொல் தொகுப்பு", "தமிழ் NLP", "அகராதியியல்", "டிஜிட்டல் தரவுத்தளம்"],
  },
  {
    ...
    answerEnglish: "The primary objectives of Sorkuvai are: (1) Collect and archive Tamil vocabulary across different time periods; (2) Create a searchable digital Tamil word corpus for linguistic research; (3) Support Tamil NLP (Natural Language Processing) tools; (4) Preserve rare and archaic Tamil words from obsolescence; (5) Facilitate Tamil machine translation and computational applications.",
    answerTamil: "சொற்குவையின் முதன்மை நோக்கங்கள்: (1) வெவ்வேறு காலகட்டங்களில் உள்ள தமிழ் சொல்வளஞ்சேரியை சேகரித்து காப்பகமாக்குதல்; (2) மொழியியல் ஆராய்ச்சிக்கு தேடக்கூடிய டிஜிட்டல் தமிழ் சொல் தொகுப்பை உருவாக்குதல்; (3) தமிழ் NLP கருவிகளை ஆதரித்தல்; (4) அரிய மற்றும் பழைய தமிழ் சொற்களை காத்தல்; (5) தமிழ் இயந்திர மொழிபெயர்ப்பை எளிதாக்குதல்.",
    keywordsEnglish: ["Sorkuvai", "vocabulary archive", "NLP", "linguistic research", "preservation"],
    keywordsTamil: ["சொற்குவை", "சொல் காப்பு", "NLP", "மொழியியல் ஆராய்ச்சி", "பாதுகாப்பு"],
  },
  {
    ...
    answerEnglish: "The Tamil Virtual Academy (TVA / TIVA) was previously known as the 'Tamil Internet Education' (தமிழ் இணைய கல்வி). It was established in 2001 and later renamed Tamil Virtual Academy. The organization operates under the Tamil Nadu Government and promotes Tamil through digital platforms, e-learning, and internet-based education.",
    answerTamil: "தமிழ் இணையக் கல்விக் கழகம் (TIVA) முன்பு 'தமிழ் இணைய கல்வி' என்று அழைக்கப்பட்டது. 2001ஆம் ஆண்டில் தொடங்கப்பட்டு பின்னர் தமிழ் இணையக் கல்விக் கழகம் என மறுபெயரிடப்பட்டது. தமிழ்நாடு அரசின் கீழ் இயங்கும் இந்த நிறுவனம் டிஜிட்டல் தளங்கள், மின்கல்வி மற்றும் இணைய அடிப்படையிலான கல்வி மூலம் தமிழை மேம்படுத்துகிறது.",
    keywordsEnglish: ["Tamil Virtual Academy", "Tamil Internet Education", "2001", "TIVA", "Tamil Nadu Government"],
    keywordsTamil: ["தமிழ் இணையக் கல்விக் கழகம்", "தமிழ் இணைய கல்வி", "2001", "TIVA"],
  },
  {
    unit: "Unit V", qNo: 12, marks: 2,
    questionEnglish: "Write a note on blogs.",
    questionTamil: "கலப்பூ - குறிப்பு எழுக.",
    answerEnglish: "A blog (கலப்பூ in Tamil – from 'blog' transliterated) is a regularly updated website or web page where individuals or groups write articles, opinions, news, or creative content. Tamil blogs have significantly contributed to promoting Tamil literature, news, culture, and language online. Platforms like Blogger and WordPress host millions of Tamil blogs written by enthusiasts worldwide.",
    answerTamil: "கலப்பூ (Blog) என்பது தனிநபர்கள் அல்லது குழுக்கள் கட்டுரைகள், கருத்துக்கள், செய்திகள் அல்லது படைப்பு உள்ளடக்கத்தை எழுதும் தொடர்ச்சியாக புதுப்பிக்கப்படும் இணைதளம் அல்லது வலைப்பக்கம். தமிழ் கலப்பூக்கள் ஆன்லைனில் தமிழ் இலக்கியம், செய்திகள், கலாச்சாரம் மற்றும் மொழியை மேம்படுத்துவதில் குறிப்பிடத்தக்க பங்களிப்பு செய்திருக்கின்றன. Blogger மற்றும் WordPress போன்ற தளங்கள் உலகெங்கும் உள்ள ஆர்வலர்கள் எழுதும் கோடிக்கணக்கான தமிழ் கலப்பூக்களை வழங்குகின்றன.",
    keywordsEnglish: ["blog", "Kalpoo", "Tamil blog", "WordPress", "online writing"],
  ...
  },
  {
    ...
    answerEnglish: "Tamil blogs (கலப்பூ) have grown significantly since the 2000s. They serve as platforms for: creative writing (short stories, poetry), political commentary, technology discussions, book reviews, and cultural journalism. Tamil bloggers' associations like 'Tamil Blogger' organized meets and awards. Blogs helped young writers publish freely, democratizing Tamil literary production in the internet age.",
    answerTamil: "தமிழ் கலப்பூக்கள் 2000ஆம் ஆண்டுகளிலிருந்து குறிப்பிடத்தக்க அளவில் வளர்ந்துள்ளன. படைப்பு எழுத்து (சிறுகதைகள், கவிதைகள்), அரசியல் விமர்சனம், தொழில்நுட்ப விவாதங்கள், புத்தக விமர்சனங்கள் மற்றும் கலாச்சார பத்திரிகையியலுக்கான தளங்களாக செயல்படுகின்றன. 'தமிழ் பதிவர்' போன்ற தமிழ் கலப்பூர் சங்கங்கள் கூட்டங்கள் மற்றும் விருதுகளை ஏற்பாடு செய்தன. கலப்பூக்கள் இளம் எழுத்தாளர்களுக்கு சுதந்திரமாக வெளியிட உதவி இணைய யுகத்தில் தமிழ் இலக்கிய உற்பத்தியை ஜனநாயகப்படுத்தின.",
    keywordsEnglish: ["Tamil blogs", "creative writing", "bloggers community", "literary platform", "2000s"],
    keywordsTamil: ["தமிழ் கலப்பூ", "படைப்பு எழுத்து", "கலப்பூர் சங்கம்", "இலக்கிய தளம்"],
  },
  {
    ...
    answerEnglish: "Online Tamil dictionaries have made Tamil vocabulary accessible worldwide. Major ones include: (1) University of Madras Tamil Lexicon Online; (2) Tamil Wiktionary; (3) Maduram Online Dictionary; (4) Agaraadhi.com (Tamil-English bilingual); (5) Sabdatharavali. These free digital tools support Tamil learners, translators, researchers, and writers globally.",
    answerTamil: "ஆன்லைன் தமிழ் அகராதிகள் தமிழ் சொல்வளஞ்சேரியை உலகளவில் அணுகக்கூடியதாக ஆக்கியுள்ளன. முக்கிய ஆன்லைன் அகராதிகள்: (1) சென்னை பல்கலைக்கழக தமிழ் அகராதி ஆன்லைன்; (2) தமிழ் விக்சனரி; (3) மதுரம் மின் அகராதி; (4) அகராதி.com (தமிழ்-ஆங்கிலம் இருமொழி); (5) சப்தத்தாரவளி. இந்த இலவச டிஜிட்டல் கருவிகள் உலகளவில் தமிழ் கற்பவர்கள், மொழிபெயர்ப்பாளர்கள், ஆராய்ச்சியாளர்கள் மற்றும் எழுத்தாளர்களுக்கு ஆதரவளிக்கின்றன.",
    keywordsEnglish: ["Tamil Lexicon", "Tamil Wiktionary", "Maduram", "Agaraadhi", "online dictionary"],
  ...
  },
  {
    ...
    answerEnglish: "Benefits of Tamil software development: (1) Enables Tamil speakers to use computers and smartphones in their native language; (2) Promotes digital literacy among Tamil communities; (3) Preserves Tamil language in the digital era; (4) Supports Tamil e-governance (government services in Tamil); (5) Creates employment for Tamil IT professionals; (6) Enables Tamil natural language processing for AI and machine translation.",
    answerTamil: "தமிழ் மென்பொருள் உருவாக்கத்தின் பயன்கள்: (1) தமிழ் பேசும் மக்கள் தங்கள் தாய்மொழியில் கணினிகள் மற்றும் ஸ்மார்ட்போன்களை பயன்படுத்த இயலுகிறது; (2) தமிழ் சமூகங்களில் டிஜிட்டல் கல்வியறிவை மேம்படுத்துகிறது; (3) டிஜிட்டல் யுகத்தில் தமிழ் மொழியை பாதுகாக்கிறது; (4) தமிழ் மின்-நிர்வாகத்தை ஆதரிக்கிறது; (5) தமிழ் IT நிபுணர்களுக்கு வேலைவாய்ப்பு உருவாக்குகிறது; (6) AI மற்றும் இயந்திர மொழிபெயர்ப்புக்கு தமிழ் NLP இயலுகிறது.",
    keywordsEnglish: ["Tamil software", "digital literacy", "e-governance", "NLP", "AI", "preservation"],
    keywordsTamil: ["தமிழ் மென்பொருள்", "டிஜிட்டல் கல்வியறிவு", "மின்-நிர்வாகம்", "NLP", "AI"],
  },
  {
    "unit": "Unit V",
    "qNo": 16,
