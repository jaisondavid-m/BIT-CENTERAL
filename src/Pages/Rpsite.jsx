...
function Rpsite() {
  ...
  return (
    <div className="dark:bg-black">
      ...
      <button onClick={() => navigate("/")} className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600 text-white text-sm font-semibold shadow-lg hover:bg-blue-700 hover:scale-105 transition-all dark:bg-blue-700 dark:hover:bg-blue-600">⬅ Home</button>
    </div>  
  )
}
