...
function Rpsite() {
  ...
  return (
    <div>
      ...
      <iframe className='w-screen h-screen block border-none' id="rewardFrame" src="https://script.google.com/macros/s/AKfycbxQARjvR6fKHRV0ry_g7NPLe4LK22snH8zkVyG44CN_7g_YQR3yyYgEn60-wrYjVgSuBA/exec" onLoad={() => setTimeout(() => setLoading(false), 500)} title="RP Site"></iframe>
